...
//  you can get scala-cli from here: https://scala-cli.virtuslab.org/install
//  after running the slides are generated in target/out.pdf
  ...
  frame("Två alternativa programmeringskurser för W"):
    ...
    itemize: 
      ...
      p("""Läses med fördel tillsammans med \\
           ...
           som ger kunskap om linux och terminalkommando""")
