    ...
    inputRef.replaceAllIn(
      ...
      m =>
        ...
        val nt =
          ...
          else if t.endsWith("plan/overview-generated.tex") then
            // full-course overview table (Swedish, generated by plan/); point at the chrome-translated
            // -en variant generated in mirror(). Matches both ../plan/ (slides) and ../../plan/ (cover).
