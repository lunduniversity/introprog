...
\newcommand{\StudyTheory}[1]{Studera begreppen i kapitel \ref{chapter:W#1}, så att du känner till  deras innebörd.}

\newcommand{\DoExercise}[2]{Gör övning {\tt #1} i kapitel \ref{exe:W#2}.}
