...
\geometry{inner=45bp,outer=45bp,top=45bp,bottom=45bp}
...
\input{modules/w05-chapter.tex}
\input{modules/w05-exercise.tex}
\input{modules/w05-lab.tex}

\input{modules/w06-chapter.tex}
\input{modules/w06-exercise.tex}
\input{modules/w06-lab.tex}

\input{modules/w07-chapter.tex}
\input{modules/w07-exercise.tex}
\input{modules/w07-lab.tex}

\input{modules/w08-chapter.tex}
\input{modules/w08-exercise.tex}
\input{modules/w08-lab.tex}

\input{modules/w09-chapter.tex}
\input{modules/w09-exercise.tex}
\input{modules/w09-lab.tex}

\input{modules/w10-chapter.tex}
\input{modules/w10-exercise.tex}
\input{modules/w10-lab.tex}

\input{modules/w11-chapter.tex}
\input{modules/w11-exercise.tex}
\input{modules/w11-lab.tex}

\input{modules/w12-chapter.tex}
\input{modules/w12-exercise.tex}
\input{modules/w12-lab.tex}
...
\input{modules/w14-chapter.tex}
\input{modules/w14-exercise.tex}
\input{modules/w14-lab.tex}

\part{Lösningar}

\chapter{Lösningar till övningarna}\label{chapter:solutions}

\input{modules/w01-intro-solutions.tex}
\input{modules/w02-programs-solutions.tex}
\input{modules/w03-functions-solutions.tex}
\input{modules/w04-objects-solutions.tex}

\input{modules/w05-solutions.tex}
\input{modules/w06-solutions.tex}
\input{modules/w07-solutions.tex}

\input{modules/w08-solutions.tex}
\input{modules/w09-solutions.tex}
\input{modules/w10-solutions.tex}
\input{modules/w11-solutions.tex}
\input{modules/w12-solutions.tex}
\input{modules/w13-solutions.tex}
\input{modules/w14-solutions.tex}
