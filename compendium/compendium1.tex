...
\externaldocument{compendium2} %to crossreference compendium2.tex
...
{\sffamily \textbf{Kompendium 1}\\Teori}\\\vspace{2cm}
\includegraphics[height=7cm]{../img/scala-icon.png}
