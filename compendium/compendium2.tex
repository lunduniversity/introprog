...
\externaldocument{compendium1} %to crossreference compendium1.tex
...
{\sffamily \textbf{Kompendium 2}\\Uppgifter}\\\vspace{2cm}
\includegraphics[height=7cm]{../img/blockmole-sky-grass.png}
