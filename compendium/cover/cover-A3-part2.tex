...
\begin{tikzpicture}[overlay,remember picture]%[overlay,remember picture]
    \fill[Pink,fill opacity=0.5] (current page.south west) rectangle (current page.north east);
    ...
    \node[above right] (picture) at ($(current page.north east)+(-16,-27.5)-(\RightMarginFront,\YPosFront)$) {\includegraphics[width=140mm]{gurka.jpg}};
...
\fontsize{16}{20}\sffamily\selectfont {DEL 2}};
