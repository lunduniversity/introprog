...
\definecolor{Background}{HTML}{5F1229}
...
\begin{tikzpicture}[overlay,remember picture]%[overlay,remember picture]
    ...
    \node[text width=250mm, align=right] (prog) at ($(current page.north east)+(-14.5,-28.8)-(\RightMarginFront,\YPosFront)$) {
       \fontsize{28}{46}\sffamily\selectfont{DEL 2
       }
       };
    ...
    \node[above right] (picture) at ($(current page.north east)+(-15,-25.5)-(\RightMarginFront,\YPosFront)$){\includegraphics[width=120mm,trim={2.4cm 2.7cm 4.2cm 2.8cm},clip]{../../img/glider-blinker-block}};
...
\fontsize{14}{20}\sffamily\selectfont {DEL 2}};
