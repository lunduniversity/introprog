...
\definecolor{Background}{HTML}{411934}
...
\begin{tikzpicture}[overlay,remember picture]%[overlay,remember picture]
    ...
    \node[above right] (picture) at ($(current page.north east)+(-15,-25.5)-(\RightMarginFront,\YPosFront)$){\includegraphics[width=120mm]{../../img/blockworm}};
