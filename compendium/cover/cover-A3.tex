...
\fontsize{16}{20}\sffamily\selectfont {2016}};

\node[above right, scale=1.3] (collection-traits) at ($(current page.west)+(3.0,-10.5)$) {
\sffamily\input{../../plan/overview-generated.tex} 
};

\node[above right, text width=15cm,align=left] (collection-traits) at ($(current page.west)+(3.0,10.5)$) {
\sffamily\large 
