...
Detta kompendium är kurslitteratur i \textit{''Programmering, grundkurs''} på \textbf{Lunds tekniska högskola} vid Lunds universitet. Kursen motsvarar 7,5 högskolepoäng och är obligatorisk i årskurs 1 för Datateknikprogrammet (D) och Infocomprgrammet (C). Kursen ges även som valfri för andra program och som fristående kurs.
