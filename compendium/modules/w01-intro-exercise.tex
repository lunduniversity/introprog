...
\Connect{funktion}       {vid anrop beräknas ett returvärde}
\Connect{procedur}       {vid anrop sker (sido)effekt; returvärdet är tomt}
...
\Connect{for-sats}       {bra då antalet repetitioner är bestämt i förväg}
\Connect{while-sats}     {bra då antalet repetitioner ej är bestämt i förväg}
\Connect{tilldelning}    {kan ändra en variabels värde}
\Connect{flyttal}        {decimaltal med begränsad noggrannhet}
\Connect{boolesk}        {antingen sann eller falsk}
...
\ConnectSolved{funktion}       {vid anrop beräknas ett returvärde}
\ConnectSolved{procedur}       {vid anrop sker (sido)effekt; returvärdet är tomt}
...
\ConnectSolved{for-sats}       {bra då antalet repetitioner är bestämt i förväg}
\ConnectSolved{while-sats}     {bra då antalet repetitioner ej är bestämt i förväg}
\ConnectSolved{tilldelning}    {kan ändra en variabels värde}
\ConnectSolved{flyttal}        {decimaltal med begränsad noggrannhet}
\ConnectSolved{boolesk}        {antingen sann eller falsk}
\end{ConceptConnections}
...
\Subtask Ta hjälp av REPL-kommadot \verb+:type+ (kan förkortas \code{:t}) vid behov för att para ihop nedan litteraler med rätt typ. \TODO{shuffla svaren}
...
\emph{Tips:} Studera dokumentationen på \Scaladoc och prova i REPL.
...
\end{Code}
Använd en \code{while}-sats för att skriva ut resultatet av 100 tärningskast med funktionen \code{roll} från uppgift \ref{exercise:expressions:roll}. 
...
\Task \what~En procedur är en funktion som orsakar en effekt, till exempel en utskrift eller en variabeltilldelning, men som inte returnerar något intressant resultatvärde. Den \emph{gör} något, men returnerar \emph{tomma värdet} \code{()} som är av typen \code{Unit}.
