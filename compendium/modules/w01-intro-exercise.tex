...
Observera att Kojo använder Scala 2 och därmed den gamla syntaxen för kontrollstrukturer med nödvändiga parenteser runt villkorsuttryck, utan varken \code{do} eller \code{then}, och varken valfria klammerparenteser eller indenteringssyntax. 
