...
\Subtask Rita en kvadrat med nu med hjälp av proceduren \code+upprepa(n){ ??? }+ där du ersätter \code{n} med antalet repetitioner och ??? med de satser som ska repeteras.
