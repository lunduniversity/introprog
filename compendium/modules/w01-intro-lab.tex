...
\Subtask Kör ditt program med den \emph{gula} play-knappen. Studera hur repetitionen påverkar exekveringssekvensen. Klicka på anropen i programspårningsfönstret och se markeringarna i bilden.
...
\Task\Pen \emph{Repetition}. Ange vilken av \code{for} och \code{while} är lämpligast i dessa fall:
