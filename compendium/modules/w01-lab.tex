...
\begin{Goals}
\input{modules/w01-lab-goals.tex}
\end{Goals}
...
\Subtask\Pen Vad händer om du \emph{inte} börjar programmet med \code{sudda} och kör det upprepade gånger? Varför är det bra att börja programmet med \code{sudda}?
