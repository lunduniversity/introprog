...
\Subtask Du ska nu generalisera din procedur så att den inte bara kan rita 10 kvadrater i en stapel. Ge proceduren \code{stapel} en parameter \code{n} som styr hur många kvadrater som ritas i en stapel.
\begin{Code}
def kvadrat = ???
def stapel(n: Int) = ???
