...
\Subtask Värde: gurkatomat upprepat 42 gånger. Typ: \code{String}

\Task % uppgift 2

Bestämda värden man skriver i koden. T.ex.  \code{1},  \code{"hej"},  \code{3.0f}
