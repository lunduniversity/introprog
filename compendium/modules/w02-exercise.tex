...
\Subtask \code{(1 to 10).foreach(i => println(i * 2))}
...
\begin{itemize}
\item Alla satser måste avslutas med semikolon.
\item Heltalsvariabler deklareras med typen \lstinline[language=Java]{int} med litet i \emph{före} namnet på variabeln. Exempel: \\ \lstinline[language=Java]{int sum = 0;}
