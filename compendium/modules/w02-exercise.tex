...
\Task \emph{Block, namnsynlighet, namnöverskuggning}. Kör nedan kod i Scala REPL eller i Kojo. Säkerställ att variablerna \code{a} och \code{b} är nya, fräscha namn som inte använts innan, genom att ev. starta om REPL eller Kojo. \\ Vad händer nedan? Varför?
...
\Subtask Vad hade du behövt ändra på efterföljande rader om import-satsen på rad 1 ovan ej hade gjorts?
...
\Subtask Skriv kommandot \code{jar} i terminalen och undersök vad som finns för optioner. Se speciellt ''Example 1.'' i hjälputskriften.
