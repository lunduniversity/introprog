...
\SubtaskSolved Ett kompilerat program måste ha ett objekt med en \code{main}-metod eftersom exekveringsmiljön JVM förutsätter detta och anropar \code{main}-metoden när när exekveringen startar.
