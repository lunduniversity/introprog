...
\noindent Spara filen och kör kommandot \code{scala-cli run sum.sc} i terminalen:
\begin{REPLnonum}
...
\end{REPLnonum}
Eftersom rrayen \code{args} är tom om programargument saknas så finns ej platsen med index $0$.
...
\Subtask Kompilera med \code{scala-cli compile hello.scala}. Vad heter filerna som kompilatorn skapar? Leta efter filer som slutar med .class i mapparna som ligger under mappen som börjar med project...
\begin{REPLnonum}
...
> scala-cli run sum-min-max.scala -- 1 2 42 3 4
52 1 42
\end{REPL}
...
> scala-cli run swap-args.scala -- hej alla barn
barn alla hej
\end{REPL}
...
\begin{REPL}
> code maxn.scala
> scala-cli maxn.scala -- 7 42 1 -5 9
42
\end{REPL}
