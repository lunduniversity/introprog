...
\item Läs igenom ''Kort teori om maskinkod'' på sidan \pageref{subsec:machinecodetheory} nedan och se till att du förstår begreppen.
    \item Titta igenom föreläsningsbilderna från dod-föreläsningen om maskinkod.
...
Här går vi kortfattat igenom några centrala begrepp som du behöver inför laborationen. Gör också uppgifterna i avsnittet \enquote{Förberedelser} \emph{innan} laborationen.
