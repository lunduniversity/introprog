...
\Subtask Returnerar det största värdet i \code{ys}. Resultatet Ã¤r \code{42}.
...
\Subtask Skriver ut \code{85}. Förklaring:
\code{a.b} refererar till variabeln \code{b} som är en del av objektet \code{a}.
\code{a.a.a} refererar till variabeln \code{a}, som befinner sig i ett objekt som heter \code{a} som i sin tur befinner sig i ett annat objekt som också heter \code{a}.
