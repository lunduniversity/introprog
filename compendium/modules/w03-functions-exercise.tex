...
\Eng{pure function} ger alltid samma resultat med samma argument (så som vi är vana vid inom matematiken) och har inga sidoeffekter (så som utskrifter).
...
\noindent Vilka funktioner i objektet \code{inSearchOfPurity} ovan är äkta funktioner? Testa att anropa funktionerna i REPL om du är osäker på vad som händer.
...
scala> plus(42)
\end{REPL}
Vilka rader ovan ger kompileringsfel?
