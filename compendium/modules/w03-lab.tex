...
\Subtask
<<<<<<< HEAD
Gå till kursens webbsida \url{https://cs.lth.se/pgk/} och ladda ner \href{https://cs.lth.se/pgk/cslib}{cslib.jar} och lägg den i samma katalog som ditt Scala program.
En \texttt{jar}-fil är egenligen en \texttt{zip}-fil som innehåller färdiga \texttt{class}-filer.
=======
Ladda ner \texttt{cslib.jar} via länken \url{https://cs.lth.se/pgk/cslib} och lägg jar-filen i samma katalog som ditt Scala program.
