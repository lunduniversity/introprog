...
\Subtask
Gå till kursens webbsida \url{https://cs.lth.se/pgk/} och ladda ner \texttt{cslib.jar} från länken \url{https://cs.lth.se/pgk/cslib} och lägg jar-filen i samma katalog som ditt Scala program.
