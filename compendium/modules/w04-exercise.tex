...
\begin{REPL}
scala> val creature = ("Doktor", "Krall", 65.0, true)
...
\Task Klass med attribut. Om man vill kunna ha flera upplagor av ett objekt med samma typ, kan man använda en klass. Man skapar nya objekt med \code{new}.
\begin{REPL}
