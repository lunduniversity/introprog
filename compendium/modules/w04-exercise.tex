...
\Task \emph{Klass med attribut.} Om du vill ha flera olika upplagor av objekt av samma typ, använd en \textbf{klass}. Man skapar nya objekt med klassen som ''mall'' för objektet med nyckelordet \code{new}.
...
scala> k1.saldo = 2000
scala> k1.nummer = 67890L
scala> println("Konto: " + k1.nummer + " Saldo:" k1.saldo)
scala> println("Konto: " + k2.nummer + " Saldo:" k2.saldo)
\end{REPL}

\Subtask Varför är attributet \code{nummer} föränderligt? (Jämför med objektet \code{mittKonto}.)


\Task \emph{Klass med attribut som parametrar.} Om man vill ge attributen initialvärden när objektet skaps med new kan man ge klassen en parameterlista. Koden som körs när objektet skapas, och tilldelningen av initaialvärden sker, kallas \textbf{primär konstruktor} \Eng{primary constructor}.
