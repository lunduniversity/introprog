...
\end{ScalaSpec}
Fundera på hur ovan specifikation kan implementeras. Du får i nedan labbinstruktioner tips om hur du kan implementera \code{FrequencyCounter} med hjälp av datastrukturen \code{scala.collection.mutable.Map[String, Int]}.
