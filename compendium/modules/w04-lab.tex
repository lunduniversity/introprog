...
\begin{Preparations}
\item \DoExercise{\ExeWeekFOUR}{04} \emph{Det är livsnödvändig kunskap för en pirat!}
...
\ScalaSpecInputListing{FrequencyCounter}{../workspace/w04_pirates/src/main/scala/pirates/FrequencyCounter.scala}
...
%  }
%\end{ScalaSpec}
\noindent Fundera på hur ovan specifikation kan implementeras. Du får i nedan labbinstruktioner tips om hur du kan implementera \code{FrequencyCounter} med hjälp av datastrukturen \code{scala.collection.mutable.Map[String, Int]}.
