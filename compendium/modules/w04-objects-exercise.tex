...
\Subtask Skriv nedan program med en editor i filen \code{hello-window.scala} och fyll i de saknade delarna så att en röd kvadrat ritas ut, med ledning av dokumentationen:\\\url{http://cs.lth.se/pgk/api/}

\begin{Code}
package hello

object Main:
  val w = introprog.PixelWindow(400, 300, "HEJ")
...
\begin{Code}
val w1 = introprog.PixelWindow()
val w2 = introprog.PixelWindow(100, 200, "Mitt fina nya fönster")
\end{Code}
...
Den tre parametrarna till \code{ java.awt.Color(r, g, b)} anger hur mycket \emph{rött}, \emph{grönt} respektive \emph{blått} som färgen ska innehålla, och mängderna ska vara i intervallet 0--255.
...
\begin{Code}
object Color:
  val mole   = java.awt.Color( 51,  51,   0)
  val soil   = java.awt.Color(153, 102,  51)
  val tunnel = java.awt.Color(204, 153, 102)
\end{Code}
\noindent Men vi vill helst göra import på \code{java.awt.Color} för att kunna använda klassens namn utan att upprepa hela sökvägen, trots att namnet krockar med namnet på vårt singelobjekt. Skriv om koden ovan med hjälp av namnbyte vid import så att färgerna kan skapas med \code{JColor(...)}. Gör importen lokalt i singelobjektet \code{Color}.
...
scala> val w = introprog.PixelWindow(400,300,"Tre nyanser av brunt")
...
object Main:
  val w = introprog.PixelWindow(width = 400, height = 300, title = "HEJ")
