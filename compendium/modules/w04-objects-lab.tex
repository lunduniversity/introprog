...
\end{center}
\caption{Varje block består av ett antal pixlar. Blocket har koordinat (1,1) i blockkoordinater medan blockets översta vänstra pixel har koordinat (7,7) i \code{PixelWindow}-koordinater om det t.ex. går sju-gånger-sju pixlar per block.}
\end{figure}
