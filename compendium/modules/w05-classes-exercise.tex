...
Om du använder \code{sbt} hamnar den kompilerade koden i \code{target/scala-3.0.1/classes}. Testa så att \code{Pos} fungerar med hjälp av REPL enligt nedan:
\begin{REPL}
> cd ~/pgk/w06/lab
> scala -cp target/scala-3.0.1/classes
