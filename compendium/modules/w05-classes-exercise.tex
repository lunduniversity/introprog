...
Testa även att anropa \code{moved} på klassnamnet, t.ex. \code{Pos.moved(0,1)}. Fungerar detta? Varför/varför inte? Reflektera över skillnaden mellan hur man anropar metoder i en klass jämfört med metoder i ett singelobjekt.
