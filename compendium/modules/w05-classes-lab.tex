...
\begin{Code}
  def rectSeqExample(t: Turtle): Unit  = {
    val startRect = Rect(Point(200, 200), 50, 30, 0)
    RectSeq(startRect, 5, 0, 70, -30, 0.67).draw(t)
  }
\end{Code}
...
\TODO{\emph{Undersök om det går att ta bort angle och använd rect.angle istället.}}
\begin{figure}[H]
\scalainputlisting[numbers=left,basicstyle=\ttfamily\fontsize{9.5}{11.2}\selectfont]%
