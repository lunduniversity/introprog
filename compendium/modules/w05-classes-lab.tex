...
\Task\Checkpoint När \code{Point}, \code{Turtle} och \code{Rect} är färdigimplementerade ska du testa klasserna i samverkan genom att köra \code{main}-metoden i singelobjektet \code{Demo} nedan. Koden finns i kursens workspace. 
