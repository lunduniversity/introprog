...
\Task Använd den färdiga \code{CardDeck}-klassen för att ta fram sannolikheterna för att kortkombinationerna ``straight flush'', ``straight'' eller ``flush'' dyker upp bland 5 kort dragna från en blandad kortlek.
