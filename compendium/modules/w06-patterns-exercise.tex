...
\SubtaskSolved
Se objektdiagrammet ovan: \code{g1} och \code{g2} refererar till samma \code{Gurka}-objekt medan \code{g3} refererar till ett eget objekt med samma innehåll --- därför ger \code{==} (som utan egen \code{equals} jämför referenslikhet) \code{true} för \code{g1 == g2} men \code{false} för \code{g1 == g3}.
