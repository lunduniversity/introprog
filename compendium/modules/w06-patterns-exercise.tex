...
Vi såg att i deluppgift \ref{task:match-sealedtrait}\ref{subtask:match-forgetcase} så varnade REPL redan vid kompilering att denna funktionen inte var uttömd \Eng{exhaustive}. Detta gäller även vid användning av \code{enum} också.
