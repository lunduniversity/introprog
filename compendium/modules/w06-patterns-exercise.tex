...
\end{REPL}
Felmeddelandet fås av att REPL:en behandlar varje inmatning individuellt och tillåter därför inte att subtypen \textbf{Spader} "förlänger" \Eng{extends} supertypen \textbf{Färg} eftersom denna var förseglad \Eng{sealed}. Mer om detta senare i kursen...
