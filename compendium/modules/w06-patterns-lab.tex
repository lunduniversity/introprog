...
\item Konstanter ska, om lämpligt, namnges och placeras i lämpligt kompanjonsobjekt.
...
\item Visa \emph{highscore} vid \emph{Game Over}.  Highscore sparas med \code{introprog.IO} i en fil som skapas om den inte finns annars läses in vid uppstart om den finns och uppdateras vid behov. Du kan välja att spara en hel highscore-lista eller bara högsta poäng hittills.
\end{itemize}
