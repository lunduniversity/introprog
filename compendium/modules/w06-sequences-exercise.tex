...
\ifPreSolution
\begin{framed}
\noindent\emph{Tips inför fortsättningen:} Normalt kan du lösa grundläggande delproblem med inbyggda samlingsmetoder ur standardbiblioteket. Men det är mycket bra för din förståelse om du kan implementera grundläggande sekvensalgoritmer själv. I kommande uppgifter ska du därför själv implementera liknande funktioner som redan finns färdigt i standardbiblioteket.
\end{framed}
\fi
