...
\Task Det visar sig att vår flitige ornitolog från uppgift \ref{task:fyle} sov på en av föreläsningarna i zoologi när hen var nolla på Natfak, och därför helt missat fylekategorin \code{Pjodd}. Hjälp vår stackars ornitolog så att typhierarkin nu även omfattar Pjoddar. En Pjodd kan både flyga och simma och  kvittrar dubbelt så många gånger som en Ånka kvackar. Låt ornitologen onyo leta fåglar i skogen och filtrera fram lämpliga arter som hen hittar och undersök hur dessa väsnas.
