...
\Subtask Skapa en metod \code{printTitle} som tar in en sträng och skriver ut den som titel på racet. Denna sträng skiljer sig från SimpleWindow-konstruktorns titelsträng, och används för att i fönstret skriva ut titeln för det nuvarande racet. Titelsträngen i SimpleWindow anger titeln för hela fönstret.
