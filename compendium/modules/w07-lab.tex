...
\subsection{Bakgrund}
I labben kommer sköldpaddor, \code{Turtle}, att får tävla mot varandra i ett lopp. Det kommer skapas sköldpaddor med olika egenskaper som kommer tävla mot varandra. Tillsist kommer det skapas en tunering av 32 sköldpaddor som kommer tävla mot varandra i först fyra kvartsfinaler , sen två semifinaler och tillsist en final.
