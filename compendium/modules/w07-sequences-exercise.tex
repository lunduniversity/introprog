...
Scalas standardbibliotek har många användbara samlingar med enhetlig metoduppsättning. Om du lär dig de viktigaste samlingsmetoderna får du en kraftfull verktygslåda. Läs mer här:
    ...
    \begin{itemize}%[nolistsep]
      \item snabbreferensen (enda tentahjälpmedel): \\{\small\url{https://cs.lth.se/pgk/quickref}}
...
\WHAT{Träna på kontrollskrivning.}

\QUESTBEGIN

\Task \what~Gör en plan för hur du ska träna inför kontrollskrivningen. Gamla kontrollskrivningar finns här: \url{https://cs.lth.se/pgk/examination/} 
