...
\Task Kopiera hela din lösning till en ny katalog och ändra implementationen så att du så mycket som möjligt drar nytta av uppräknade datatyper med \code{enum} i stället för heltal och strängsekvenser. Diskutera med handledare för- och nackdelar med de två olika sätten att lösa uppgiften på. 
