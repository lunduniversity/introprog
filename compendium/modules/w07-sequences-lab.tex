...
\Task Diskutera med handledare vid redovisningen vilka fördelar och nackdelar med att använda \code{lazy val} i stället för \code{val} eller \code{def} i en oföränderlig klass.
