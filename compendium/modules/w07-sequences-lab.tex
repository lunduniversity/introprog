...
\Task Kopiera hela din lösning till en ny katalog och ändra implementationen så att du drar nytta av uppräknade datatyper med \code{enum} i stället för heltal och strängsekvenser på alla ställen där det är möjligt och lämpligt. Diskutera med handledare för- och nackdelar med de två olika implementationerna. 
