...
Med metoden \code{s.split(' ').toVector} kan man dela upp en sträng \code{s} i en vektor av ord. Använd metoderna \code{split} och \code{toSet} för skapa ett uttryck som beräknar hur många unika ord det finns strängen \code{hej} nedan:
\begin{REPL}
