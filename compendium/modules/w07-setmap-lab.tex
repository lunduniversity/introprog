...
Dela upp strängen \code{source} genom att i tur och ordning göra följande:
...
\scalainputlisting[numbers=left,basicstyle=\ttfamily\fontsize{10.4}{12.5}\selectfont]{../workspace/w07_words/src/main/scala/nlp/Main.scala}
