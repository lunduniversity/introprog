...
\Task \label{task:plynomial} \emph{Polynom}. Med hjälp av objektet \code{polynomial} nedan, kan man göra följande:
\begin{REPL}
...
\Subtask\Pen Förklara vad som händer ovan genom att studera koden för \code{object polynomial} nedan.\footnote{Koden finns även här:\\ \href{https://github.com/lunduniversity/introprog/tree/master/compendium/examples/polynomial}{github.com/lunduniversity/introprog/tree/master/compendium/examples/polynomial}}
