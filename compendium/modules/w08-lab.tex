...
\Subtask Implementera metoden \code{unapply} som ska ta in en sträng (t.ex. "E2") och tonens nummer. "E2" kommer översättas till 16 och "C1" till 0, dock kommer t.ex. C\# inte kunna ha en oktavering. Använd attributet \code{toNumber} för att översätta en ton utan oktav ("C\#", "E") till ett nummer. Titta gärna på vad metoden \code{zipWithIndex.toMap} gör och Använd den i \code{toNumber}.
