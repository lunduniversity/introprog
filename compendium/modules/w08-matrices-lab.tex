...
\begin{Goals}
\input{modules/w08-matrices-lab-goals.tex}
\end{Goals}
...
\item Levande celler ska ha den vackra rosa\footnote{\url{https://www.dsek.se/rasa}} RGB-färgen \code{(242, 128, 161)}.
...
\item Studera dokumentationen om avlusaren (debuggern) i din IDE. \footnote{\url{https://scalameta.org/metals/docs/editors/vscode\#running-and-debugging-your-code}}  \footnote{\url{https://code.visualstudio.com/docs/editor/debugging}} 
\end{enumerate}
