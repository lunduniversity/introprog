...
Följande funktionella krav ska uppfyllas av ditt program om ni är sex personer i gruppen. Om ni är färre kan ni välja att skippa några krav enligt efterföljande tabell.
...
\end{itemize}
\begin{table}[H]
  \caption{Krav som ska implementeras vid olika gruppstorlek.}
\begin{tabular}{r | l l l l l}
  Krav & 2 & 3 & 4 & 5 & 6 \\ \hline

\end{tabular}
\end{table}
Om någon student, p.g.a. långvarig sjukdom eller annat giltigt skäl, genomför laborationen själv i efterhand som en individuell laboration ska följande krav implementeras på egen hand: \code{Player}, \code{OnePlayerGame}, \code{Snake}, \code{Apple}.

\subsubsection{Given design}
