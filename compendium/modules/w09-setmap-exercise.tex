...
val inköpslista = List(
      ...
      Matvara("kycklingbröst", Avdelning.Kött, 50),
...
\Subtask Använd funktionen groupMap för att dela upp matvarorna utifrån avdelningen där de kan hittas.
\Subtask Använd funktionen groupMapReduce för att ta reda på vad den sammanlagda kostnaderna för varje avdelning kommer att vara 
