...
\begin{Preparations}
\item Titta igenom föreläsningsbilderna från föreläsningen (versionshantering med Git och GitHub).
...
\end{Code}
          Byt gärna ut \code{nano} mot en editor du föredrar och som är installerad på systemet, t.ex. \code{code --wait} (för Visual Studio Code). Notera att vissa editorer, t.ex. \code{code}, kräver extra flaggor för att fungera korrekt tillsammans med git.
...
Här ges lösningar till de uppgifter som är markerade. Försök lösa uppgifterna utan denna hjälp först. Ta gärna hjälp av en \enquote{cheat sheet}.
