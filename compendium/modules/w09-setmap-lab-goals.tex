...
\item Kunna använda nyckel-värde-tabeller med samlingen \code{Map}.
\item Kunna använda mängder med samlingen \code{Set}.
\item Förstå skillnader och likheter mellan en sekvens och en mängd.
\item Förstå skillnader och likheter mellan en sekvens av par och en nyckel-värde-tabell. 
\item Kunna implementera algoritmer som använder nästlade strukturer. 
\item Kunna kombinera förändringsbara och oföränderliga samlingar.
