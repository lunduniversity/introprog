...
\Subtask \emph{Linjärsökning med find.} Sök upp första bästa kurs som ges vid institutionen för datavetenskap som är på G2-nivå med hjälp av linjärsökning med samlingsmetoden \code{find}. Kurskoder vid datavetenskap börjar på EDA eller ETS. \emph{Tips:} Du har nytta av att definiera predikatet \code{def isCS(s: String): Boolean} som i sin tur lämpligen nyttjar strängmetoden \code{startsWith}.
