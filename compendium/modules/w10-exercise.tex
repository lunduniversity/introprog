...
\item Javas \code{Comparable} och Scalas \code{Ordered} används som sypertyp för klasser som vill kunna jämföra ''sig själv'' med andra objekt och har \emph{en} naturlig ordningsdefinition.
\end{itemize}
