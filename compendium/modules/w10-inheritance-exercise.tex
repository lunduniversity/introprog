...
\WHAT{Olika typer av heltalspar till veckans laboration \hyperref[section:lab:\LabWeekTEN]{\texttt{\LabWeekTEN}}.}
...
\Subtask Skriv kod som använder de olika konkreta klasserna i \code{package numbers}. Om du kompilerar koden i samma katalog som du kör igång REPL är det bara att använda paketet direkt, som ett litet ''matetmatiklaboratorium'':
\begin{REPL}
