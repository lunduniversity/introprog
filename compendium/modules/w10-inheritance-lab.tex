...
\scalainputlisting{../workspace/w09_snake/src/main/scala/snake/Main.scala}
% \begin{Code}
% package snake
%
% object Main {
...
\scalainputlisting{../workspace/w09_snake/src/main/scala/snake/Entity.scala}
% \begin{Code}
% trait Entity {
%   def draw():   Unit
%   def erase():  Unit
...
\item \code{CanMove} representerar en spelvarelse som kan röra sig i en viss hastighet, enligt:
\scalainputlisting{../workspace/w09_snake/src/main/scala/snake/CanMove.scala}
...
\item \code{CanTeleport} representerar en frukt som finns på en viss plats men som efter ett visst antal uppdateringar utan förvarning teleporterar sig till en ny position:
\scalainputlisting{../workspace/w09_snake/src/main/scala/snake/CanTeleport.scala}
...
{../workspace/w09_snake/src/main/scala/snake/Player.scala}
...
Gruppen ska implementera \emph{minst ett} (gärna flera) av kraven nedan. Vid implementation av några av dessa krav blir spelet väsentligt roligare.
\begin{itemize}[nosep, label={$\square$}]
...
% {../workspace/w09_snake/src/main/scala/snake/Apple.scala}
%
% Här följer en skiss på klassen \code{Banana}:
% \scalainputlisting%[basicstyle=\ttfamily\fontsize{9.1}{12.2}\selectfont]
% {../workspace/w09_snake/src/main/scala/snake/Banana.scala}
...
{../workspace/w09_snake/src/main/scala/snake/Snake.scala}
...
{../workspace/w09_snake/src/main/scala/snake/SnakeGame.scala}
