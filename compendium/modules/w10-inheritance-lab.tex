...
\begin{Preparations}
\item Gör övning {\tt \ExeWeekNINE} i kapitel \ref{exe:W10}, speciellt uppgift \ref{exe:inheritance:labprep-pair}.
...
\item \textbf{\texttt{Monster}}. Det ska finnas (minst ett) monster. Ett monster består av fem rosa block i kryssform.  Ett monster föds på en slumpvis position och rör sig i en riktning som bestäms vid monstrets födelse. Ett monster blir uppätet och dör om ormens huvud nuddar ett monsterblock.
