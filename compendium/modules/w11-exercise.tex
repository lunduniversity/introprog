...
\Task Implementera och testa sortering på plats i en array med heltal med \emph{insättningssortering}\footnote{\href{https://en.wikipedia.org/wiki/Insertion_sort}{en.wikipedia.org/wiki/Insertion\_sort}}. 
