...
\Subtask Vilka typer konverteras Scalasamlingarna \code{Vector[Int]}, \code{Set[Char]} och \code{Map[String, Int]} till om du anropar metoden \code{asJava} på dessa?

\Subtask Vilka typer konverteras Javasamlingarna \code{ArrayList[Int]} och \code{HashSet[Char]} till om du anropar metoden \code{asScala} på dessa? Blir det föränderliga eller oföränderliga motsvarigheter?
