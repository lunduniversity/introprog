...
\newline
%%%%%%%ERRROR \includegraphics[width=\textwidth]{../img/w11-lab/lthopoly.png}
...
För att skriva metoden action kommer ni behöva nyttja att klassen \code{GameBoard} har statiska konstanterna som representerar de olika spelarvalen.
\newline
\newline
\noindent
