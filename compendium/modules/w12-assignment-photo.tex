...
I detta projektet använder vi oss av \code{introprog.Image} för att representera en bild. Läs på om klasserna i introprog här: \url{https://fileadmin.cs.lth.se/pgk/api/api/introprog.html}
...
I projektet används flera klasser från kursens introprog bibliotek. Särskilt används \code{Image, PixelWindow, IO}.
