...
För att spara plats vid bearbetning av stora bilder så använder vi, heltalsmatriser med typen \code{Short}, som använder 16 bitar i minnet, istället för \code{Int}, som använder 32 bitar i minnet. 
...
\subsection{Matris med värden av typen \texttt{Short}}
