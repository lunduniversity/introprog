...
\item Vid tryck på Exit-knappen ska en varningsfråga ''Ok to Exit without save?'' ges med hjälp av \code{introprog.Dialog.isOK} och användaren ska kunna ångra avslut.
...
Använd nedan \code{kernel} enligt $K$ ovan och låt \code{weight} vara summan av alla element i $K$. 
