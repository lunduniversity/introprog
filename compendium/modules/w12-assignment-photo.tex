...
\Task \textbf{Eget filter}. Skapa ett eget filter som utnyttjar att \code{apply}-metoden tar emot en sekvens av värden. Till exempel så kan du skapa ett filter som tar fem värden där de två första värdena representerar ett intensitetsintervall och de tre sista värdena representerar röd-, grön- och blå-komponenterna till en färg som ska gälla där intensiteten hamnar utanför det givna intervallet. 
