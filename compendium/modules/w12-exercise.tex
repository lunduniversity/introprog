...
\Task \emph{Använda \code{Future} för att ladda ner flera saker samtidigt.}
...
\Task \emph{Studera dokumentation.} 


\Subtask Studera dokumentationen för \code{scala.concurrent.Future}\footnote{\href{http://www.scala-lang.org/files/archive/api/current/\#scala.concurrent.Future}{http://www.scala-lang.org/files/archive/api/current/\#scala.concurrent.Future}}. Hur samverkar \code{Future} med \code{Try}? Vilka vanliga metoder på samlinbgar känner du igen?
...
\Task\Pen Svara på nedan teorifrågor.
...
\Task Läs om Scala.JS\footnote{\href{https://www.scala-js.org/}{www.scala-js.org/}} och ta reda på vad det används till.
