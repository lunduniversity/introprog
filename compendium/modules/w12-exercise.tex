...
\Task \emph{Jämlöpande exekvering med \code{scala.concurrent.Future}.} Att hålla reda på trådar kan bli ganska knepigt. Med hjälp av \code{scala.concurrent.Future} kan man sätta igång beräkningar i nya trådar och sedan köra vidare med annat. 
