...
Även \code{File}-objekt kan användas som konstruktorargument för \code{Scanner}. Om en sträng används som konstruktorargument kommer \code{Scanner} läsa själva strängens innehåll, inte filen som sökvägen i strängen leder till.
