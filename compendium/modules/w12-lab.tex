...
\subsection{Obligatoriska uppgifter}
    ...
    % Visa gärna hur den ska se ut.
        ...
        \code{rows} arrayer av storlek \code{cols} i en array vilket kan ses som en matris.
        ...
        konvention med \code{rows} arrayer och \code{cols} platser i varje array.
...
\Task{Implementera andra regler för cellulära automata.}
    ...
    \Subtask{Implementera Wireworld}
        ...
        \begin{figure}[h]
            ...
            \end{center}
            \caption{En enkel dator implementerad i Wireworld \href{http://www.quinapalus.com/wi-index.html}}
        \end{figure}
