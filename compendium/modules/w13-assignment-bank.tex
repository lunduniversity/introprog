...
\item Allt som berör användargränssnittet (såsom utskrifter till terminalen och inläsning från terminalen) ska ske i \code{BankApplication}. Det är tillåtet att använda valfritt antal hjälpmetoder och hjälpklasser i \code{BankApplication}.
