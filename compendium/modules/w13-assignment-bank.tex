...
Till din hjälp innehåller kursens workspace de färdigskrivna klasserna \code{HistoryEntry}, \code{Date} samt \code{BankEvent} med tillhörande subtyper. Du får göra ändringar i dem om du vill, men det går också bra att använda dem oförändrade.
...
\Subtask När något läggs till i historiken ska det också skrivas till en historikfil omedelbart. Banken ska ej behöva avslutas för att utskriften ska hamna på fil, om så vore fallet kan information gå förlorad om banken kraschar.
...
\noindent
Använd \code{toLogString}-metoden i \code{HistoryEntry} för att få utskrifter i rätt format.
