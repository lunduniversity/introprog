...
\begin{multicols}{2}
\small
\lstinputlisting{../workspace/w13_bank_proj/bank_log.txt}
\end{multicols}

\noindent
Formen är alltså: \textbf{År  Månad  Dag  Timme  Minut  BankEventTyp  Argument}. De olika sorternas \code{BankEvent} representeras med följande bokstäver: D för \code{Deposit}, W för \code{Withdraw}, T för \code{Transfer}, N för \code{NewAccount} och E för \code{DeleteAccount}.
