...
\end{Code}
\caption{En enkel konfigurationsfil för \sbt som innehåller det som betecknas som en \textit{build definition} i \texttt{sbt}-termer. Filen ska ha namnet \code{build.sbt} och vara placerad i projektets baskatalog.}
