...
Efter kritik om att \sbt~är komplicerat och långsamt så har flera alternativa byggverktyg för Scala utvecklats, däribland \code{bleep}\footnote{\url{https://bleep.build/docs/}} och \code{mill}\footnote{\url{https://mill-build.com/mill/Intro_to_Mill.html}}. 
...
\section{Byggfunktioner i Scala Command Line Interface}\label{appendix:build:scala-cli}

\TODO


\section{Scala Build Tool -- sbt}\label{appendix:build:sbt}
