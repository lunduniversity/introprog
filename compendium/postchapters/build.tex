...
\href{https://scala-cli.virtuslab.org/}{Scala CLI} utvecklas av \href{https://virtuslab.com/}{Virtuslab} som öppen källkod och är sedan 2023 det officiella byggverktyget för enkla Scala-projekt och medföljer \href{https://www.scala-lang.org/download/}{installationen av Scala}. Scala CLI kördes tidigare med kommandot \code{scala-cli}, men är numera liktydigt med kommandot \code{scala} i terminalen.
...
\texttt{-deprecation} & Förklaring vid användning utgående funktioner. \\
