...
Scala använder JDK som exekveringsmiljö, men går även att köra i browsern med Scala.JS. I denna kurs använder vi i Scala på JVM.
...
\begin{REPLnonum}
$ scala
Welcome to Scala 2.12.9 (Java HotSpot(TM) 64-Bit Server VM, Java 1.8.0_101).
Type in expressions for evaluation. Or try :help.
