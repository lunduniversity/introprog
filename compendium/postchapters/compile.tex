...
\item Kör igång REPL i aktuell katalog med dina Scala- och Java-program automatiskt kompilerade och tillgängliggjorda i REPL. Med optionen \code{-S} anger du vilken version av Scala du vill köra:\\
\code{scala-cli repl . -S 3}

\item Kompilera alla Scala- och Java-program i aktuell katalog och se eventuella felmeddelanden. Med hjälp av \code{--watch} (kan förkortas till \code{-w}) så kompileras alla filer automatiskt om så fort ändringar sparas:\\
\code{scala-cli compile . -S 3 --watch}
