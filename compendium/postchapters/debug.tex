...
När man ska lära sig mer om fel i programvarubaserade system, och hur de kan åtgärdas, är det viktigt att noga skilja på \textbf{misstag} \Eng{misstake}, \textbf{felorsak} \Eng{fault} och \textbf{felyttring} \Eng{failure}. 
