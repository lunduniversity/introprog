...
I figur \ref{fig:scaladoc:mio} på sidan \pageref{fig:scaladoc:mio} visas exempel på dokumentationskommentarer. Annoteringen \code{@param} i början på en rad ger en speciell kommentar angående parametrar. Annoteringen \code{@return} i början av en rad ger en speciell kommentar angående vad som returneras vid metodanrop.
