...
Du genererar dokumentation enklast med hjälp av körverktyget \code{scala-cli} eller byggverktyget \code{sbt}. 
I terminalen skriv \\\code{scala-cli doc . -o api} \\eller \\\code{sbt doc}

När \code{scala-cli} eller \code{sbt} är färdig med att generera dokumentationen så meddelas vilken katalog som dokumentationen ligger i. Du läser dokumentationen genom att öppna filen \texttt{index.html} i en webbläsare.
