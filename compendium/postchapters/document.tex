...
Du genererar dokumentation enklast med hjälp av byggverktyget \texttt{sbt}. Skriv \texttt{sbt doc} i terminalen. När \code{sbt} är färdig med att generera dokumentationen så meddelas vilken katalog som dokumentationen ligger i. Du läser dokumentationen genom att öppna filen \texttt{index.html} i en webbläsare.
