...
\begin{enumerate}
  ...
  \item Kombinera Scala CLI eller \code{sbt} och VS Code. Kör  \texttt{scala-cli compile . -w} eller \code{sbt ~compile} i ett separat terminalfönster. Då kommer kompileringsfel visas där varje gång du sparar en ändring i VS Code med Ctrl+S. När alla kompileringsfel är åtgärdade och du är redo att testköra så klickar du på \textsf{run}.
\end{enumerate}
