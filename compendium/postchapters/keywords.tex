...
Nyckelord är ord som har speciell betydelse och som gör det lättare för kompilatorn att tolka källkoden, eftersom nyckelorden är reserverade för endast ett användningsområde. Man kan till exempel inte använda nyckelordet \code{def} som namn på en variabel. Nyckelord ges ofta en speciell färg av de kodeditorer som har så kallad syntaxstyrd färgning.
