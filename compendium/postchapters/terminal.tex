...
Ibland kan du behöva uppdatera din PATH för att program som du installerat ska bli allmänt tillgängliga. Detta görs på lite olika sätt i olika operativsystem, för Linux se t.ex. här:
...
\texttt{mkdir} \textit{p} & ''make dir'', skapa en katalog \textit{p}\\
