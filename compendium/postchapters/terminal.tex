...
\code|/| & ''slash'', filträdets rot om i början av sökvägen, men biblioteksavskiljare om inuti sökvägen \\
\code|.| & aktuellt bibliotek, där du ''står'' \\
\code|..| & ett steg ''upp'' i filträdet \\
\code|"| & omgärda en sökväg med citationstecken i början och slutet om sökvägen innehåller annat än engelska bokstäver, t.ex. blanktecken\\
\code|\ | & \textit{backslash-space} används för att skriva mellanslag \\
\end{tabular}
