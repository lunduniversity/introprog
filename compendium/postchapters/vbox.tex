...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{../img/\VMName-ehus.png}
...
\item Starta maskinen \textbf{pgk-\VMName} med ett dubbelklick. Ha lite tålamod innan maskinen är igång. Du kan behöva justera skärmstorleken i värdmaskinsmenyn \Menu{View}. Du  behöver lösenordet\footnote{\code{pgkBytMig2019}} för att logga in och för att installera nya program. 
