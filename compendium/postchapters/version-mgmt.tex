...
Git är skapad för \textbf{distribuerad} versionshantering där var och en kan jobba snabbt och smidigt i sitt lokala repo, utan att behöva vänta på att klinet ska synkronisera koden med ett centralt repo på en server över nätverket. Ändringar delas mellan repo på begäran ev enskilda utvecklare. 
...
\TermItem{commit}{inlämning}{lämna in} 
  En avgränsad mängd nya ändringar lämnas in i det lokala repot.
...
\begin{itemize}
\item Skapa en lokal kopia av ett fjärran repo på kodlagringsplatsen GitHub:
\begin{REPLnonum}
$ git clone --depth 1 https://lunduniversity/introprog
\end{REPLnonum} 
