...
\section{\ifswedish Valfri tentamen \else Optional written exam \fi}

Kursen avslutas med en \emph{valfri skriftlig tentamen} med snabbreferensen\footnote{\url{https://fileadmin.cs.lth.se/pgk/quickref.pdf}} som enda tillåtna hjälpmedel. Du måste vara godkänd på obligatoriska moment för att få tentera. Tentamensuppgifterna är uppdelade i två delar, del A och del B, med följande preliminära betygsgränser:
...
\begin{itemize}
\item  För betyg 4 krävs prel. minst $67\%$ av maxpoängen.
\item  För betyg 5 krävs prel. minst $83\%$ av maxpoängen.
\end{itemize}
\end{itemize}
