...
\TODO \emph{obligatoriskt muntligt prov}

\section{Valfri tentamen}

Kursen avslutas med en \emph{valfri skriftlig tentamen} med en snabbreferens\footnote{\url{http://cs.lth.se/pgk/quickref}} som enda tillåtna hjälpmedel. Tentamensuppgifterna är uppdelade i två delar, del A och del B. Följande preliminära gränser gäller:
