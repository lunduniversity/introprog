...
\item Publika diskussioner, t.ex. i \emph{issues} och \emph{pull requests} på GitHub, sker på engelska. I en framtid kan delar av materialet komma att översättas till engelska och då är det bra om även icke-svenskspråkiga kan förstå vad som har hänt. Alla ändringshändelser sparas och man kan söka och gå tillbaka i historiken.
...
Att börja med att bidra till dokumentation är ofta en bra väg att komma in i ett öppen-källkodsprojekt, då det är en god chans att hjälpa till utan att det behöver kräva djup kompetens om koden i repot\footnote{Ordet repo är en förkortning av repositorium, här i betydelsen en lagringsplats för kod.}. Jag beskriver nedan vad som hände steg för steg då jag fick en riktig PR accepterad, som ett typiskt exempel på hur det ofta fungerar.
...
\begin{itemize}[nolistsep, noitemsep]
  \item Ärendetiteln är extra viktig: den ska sammanfatta på en enda rad vad det hela rör sig om så att läsaren av rubriken förstår vad problemet handlar om.
...
\item Jag fick snabbt kommentarer på mitt ärende, vilket är kännetecknande för en väl fungerande gemenskap \Eng{community} med alerta reposkötare  \Eng{maintainers}. Och när jag fick uppmuntran att bidra, så erbjöd jag mig att implementera förbättringen.

\item Tänk på att alltid skriva alla kommentarer och svar i en saklig, kortfattad och trevlig ton!
