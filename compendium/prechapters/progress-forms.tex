...
\vspace{1em}\noindent
{Till varje \textbf{laboration} hör en \textbf{övning} med uppgifter som utgör förberedelse inför labben. Du behöver minst behärska grunduppgifterna för att klara labben inom rimlig tid. 
I \textbf{muntaträningen} för varje vecka ingår att i dialog med handledare visa att du självständigt med papper och penna kan skriva kod, t.ex. med en funktion eller algoritm, som illustrerar veckans grundläggande koncept.
Om du känner att du behöver öva mer på grunderna, gör då även extrauppgifterna. Om du vill fördjupa dig, gör fördjupningsuppgifterna som är på mer avancerad nivå. Kryssa för nedan vilka övningar du har gjort, så blir det lättare för din handledare att anpassa dialogen till de kunskaper du förvärvat hittills.}
...
\newcommand{\ExeRow}[1]{\hyperref[section:exe:#1]{\texttt{#1}} & \TickBox  &  \TickBox &  \TickBox &  \TickBox  \\ } %\addlinespace }
...
\newcommand{\LabRow}[1]{\\[-1.1em] \hyperref[section:lab:#1]{\texttt{#1}} & \dotfill &  \dotfill  \\[0.5em]}  %\addlinespace }
...
\multicolumn{2}{c}{\textit{Om egendef., ge kort beskrivning här:}}  \\[0.5em] %\addlinespace
{\Large$\square$}\texttt{~~~\hyperref[section:proj:music]{music}} \\[0.5em] %\addlinespace
{\Large$\square$}\texttt{~~~\hyperref[section:proj:photo]{photo}}  \\[0.5em] %\addlinespace
