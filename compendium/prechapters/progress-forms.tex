...
\newcommand{\LabRow}[1]{\\[-1.1em] \hyperref[section:lab:#1]{\texttt{#1}} & \dotfill &  \dotfill  \\[1em]}  %\addlinespace }
...
\multicolumn{2}{c}{\textit{Om egendef., ge kort beskrivning här:}}  \\[0.8em] %\addlinespace
{\Large$\square$}\texttt{~~~\hyperref[section:proj:tabular]{tabular}} \\[0.8em] %\addlinespace
{\Large$\square$}\texttt{~~~\hyperref[section:proj:music]{music}} \\[0.8em] %\addlinespace
{\Large$\square$}\texttt{~~~\hyperref[section:proj:photo]{photo}}  \\[0.8em] %\addlinespace
