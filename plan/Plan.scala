trait Plan {
  ...
  lazy val modules: Seq[Module] = Vector(
    ...
    Module("Repetition, trösklar, luckor",  
      id = "rebootcamp", exercise = "reboot-plan", lab = "reboot-check", contents = "REBOOT CAMP: identifiera dina egna lärandetrösklar och kunskapsluckor, kom-i-kapp med övningar och labbar, repetera, fördjupning för de som är redo, specialträning för behövande"),
