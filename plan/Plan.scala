trait Plan {
  ...
  lazy val modules: Seq[Module] = Vector(
    ...
    Module("Program",
      ...
      | kompilerad app, skript, main i Scala, scalac, main i Java, javac,
    ...
    Module("Funktioner",
      ...
      | parameter, argument, returtyp, värdeandrop, namnanrop, default-argument,
      | namngivna argument, parameterlista, funktionshuvud, funktionskropp,
      | tupel, multipla returvärden,
      | block, lokala variabler, skuggning,
      | lokala funktioner,
    ...
    Module("Objekt",
      ...
      | namnrymd, synlighet, privata medlemmar, inkapsling,
    ...
    Module("Klasser",
      ...
      | case-klass,
      | new, null, this,
      | accessregler, private, private[this], kompanjonsobjekt,
      | getters och setters, principen om uniform access,
