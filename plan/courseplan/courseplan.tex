...
\item
  ...
  \begin{itemize}
  \item
    \emph{Laborationer} bedöms av handledare på schemalagd tid.
  \item
  ...
  \item
    \emph{Projektuppgift} görs individuellt och bedöms av handledare på
    schemalagd tid.
  \end{itemize}

\item
  \emph{Muntligt prov och tentamen (3 hp)}. Det muntliga provet är obligatoriskt. Godkänt muntligt prov krävs för betyg 3. Skriftlig tentamen är valfri och kan ge betyg 4 el. 5. Tillåtet hjälpmedel:
...
\input{../module-plan-generated.tex}
\end{tabular}
}
}
