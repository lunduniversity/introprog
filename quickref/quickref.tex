...
\LangTitle{ \vspace*{-1.0em} Scala 3.4 QuickRef @ Lund University}
...
\verb|scala-cli run hi.scala -- 42|\\
...
\verb|scala-cli run . -- 42|\\Main program arguments after \code{--} 
\\[0.2em]
...
Run with: \code{scala-cli test MyTests.test.scala --toolikt deafult}\\[-0.25em]
