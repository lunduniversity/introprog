...
\vspace*{-2.1em}\head{scala.util.\{Try, Success, Failure\} to handle exceptions as values
%, scala.concurrent.Future
}\Newline
...
\vspace*{-0.5em}\begin{Code}
val jsonString = """{"name": "Anna", "age": 13, "pets": ["Cat", "Dog"]}"""
...
val po = PetOwner("Joe", List("Cat", "Dog"))
val jsPo: String = write(po) // """{"name":"Joe","pets":["Cat","Dog"]}""""
...
\clearpage
%\Newline
\vspace*{-2.1em}\head{Mutation methods in \texttt{mutable.\{ArraySeq[A], ArrayBuffer[A], ListBuffer[A]\}}}\Newline%
\vspace*{-0.5em}%
...
\Newline
\vspace*{-0.5em}\head{Mutation methods in \texttt{mutable.Set[A]}}%
\Newline\vspace*{-0.5em}%
{\small\renewcommand{\arraystretch}{1.125}
...
\Newline
\vspace*{-0.5em}\head{\texttt{Map[K, V]}}%
\Newline\vspace*{-0.5em}%
...
\Newline
\vspace*{-0.5em}\head{Mutation methods in \texttt{mutable.Map[K, V]}}%
\Newline\vspace*{-0.5em}%
...
\vspace{0.5em}\head{Factory examples:}\Newline
