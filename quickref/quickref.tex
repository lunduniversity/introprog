...
\LangMarker{Scala}{1.5cm}{7}
\LangTitle{LTH Scala Quick Ref}
...
\LangMarker{Java}{3.5cm}{5}

\LangTitle{LTH Java snabbreferens}
\vspace{1em}

{\small \Or~står för ''eller''. \RepL \RepR används för att gruppera alternativ. \OptL \OptR markerar sådant som inte alltid finns med. \jcode{stmt} är en sats. \jcode{x}, \jcode{i}, \jcode{s}, \jcode{ch} är variabler, \jcode{expr} är ett uttryck, \jcode{cond} är ett logiskt uttryck. Med \verb|...| avses valfri, extra kod.}
...
\head{Free page with room for more ... }\Newline

\Newline

TODO: Update Java Quickref:
\begin{itemize}
\item Include new Java 8 stuff
\item Improve formatting of code
\item Translate to English
\end{itemize}
