...
\LangTitle{ \vspace*{-1.0em} Scala 3.9 QuickRef @ Lund University}
...
\code|//> using dep se.lth.cs::introprog:1.5.0| \hfill\Comment{Note: double colon adds Scala version to jar. }\\[0.5em]
Or as argument in terminal:
\code|scala repl --dep "se.lth.cs::introprog:1.5.0"|\\[0.5em]
Using library dependency from Github, one line per dependency, note single colon and quotes:\\
