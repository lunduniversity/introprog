...
\vspace{0.0em}\head{Extension methods}\Newline
...
\vspace{0.5em}\head{scala.util.\{Try, Success, Failure\} to handle exceptions
%, scala.concurrent.Future
}\Newline
...
\vspace{0.5em}\head{Contextual abstractions}\Newline
