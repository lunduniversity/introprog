...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{1.0em}\head{Special methods}\Newline
{\small
\begin{tabular}{@{}l @{}l}
\code|class A(initX: Int = 0):| & \Comment{primary constructor: \textbf{new} optional, A(1), default arg: A()} \\
...
\code|    _x = i  | & \Comment{val a = A(1); a.x = 2} \\
\code|  | & \Comment{} \\
\code|object A: | & \Comment{companion object if same name and in same code file} \\
\code|  def apply(i: Int = 0) = new A(i) |  & \Comment{factory method, apply is optional:  A.apply(1), A(1), A()} \\
