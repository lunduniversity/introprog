...
\\[0.2em]
\textbf{Start REPL:} ~\verb|scala repl .|\\[0.2em]
\hfill
...
\code|val input = scala.io.StdIn.readLine("> ") | \Comment{Reads keystrokes in terminal after printing prompt >} \\[0.5em]

\vspace{0.25em}\Comment{\textbf{Write} string to \textbf{file} using java.nio:}\\[0.5em]
...
Alternative to scala.io, java.nio: use \textbf{Scala toolkit} os.write os.read etc, see page 12.
}
