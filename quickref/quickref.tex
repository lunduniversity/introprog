...
Evaluation order   & \code|(1 + 2) * 3| & \Comment{parenthesis control order} & \multicolumn{2}{r}{\textbf{Precedence} of operators beginning with:}\\ 
...
Supertype reference & \code|super.m|  &  \Comment{refers to member m of a supertype} & other special chars & \textbf{highest} \\
...
Integer division  & \code|a / b|  &  \Comment{no decimals if a, b Int, Short, Byte } &  \\
