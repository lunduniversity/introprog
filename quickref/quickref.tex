...
{\small Version 1.2. License: CC-BY-SA, \textcopyright~Dept. of Computer Science, Lund University.}\\
...
%\Newline
\vspace*{-1.5em}\head{Methods in trait \texttt{Set[A]}}\Newline
...
\Newline
\vspace*{-0.25em}\head{Additional mutation methods in trait \texttt{mutable.Set[A]}}\Newline
{\small\renewcommand{\arraystretch}{1.125}
\begin{tabular}{@{}p{5cm}  p{6.6cm}}
...
\texttt{ms.mapValues} & A new Map obtained by applying f to values.\\   \cline{1-2}
...
\Newline
\vspace*{-0.25em}\head{Additional mutation methods in trait \texttt{mutable.Map[K, V]}}\Newline
