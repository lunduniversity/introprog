...
A \textbf{definition} binds a name to a value/implementation, while a \textbf{declaration} just introduces a name (and type) of an abstract member. Below \code|defsAndDecl| denotes a list of definitions and/or declarations. Template bodies \code|{ ... }| are optional, can be replace by \code{:} that opens an indentation region. Function bodies \code{=} also open indentation region
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage\vspace*{-2.0em}\head{Special methods (getter, setter apply, update), Companion object}\Newline
{\small
\begin{tabular}{@{}l @{}l}
...
\code|end A| & \Comment{optional end marker, also allowed: \texttt{end class}} \\
