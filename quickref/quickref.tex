...
%\textbf{Compile}:  & \verb|scala compile hi.scala| \\
...
\code{scala run hi.scala --toolkit default} \hfill\Comment{Use stable vers. of Scala toolkit, an extended std libary. }
