...
\clearpage
%\Newline
\vspace*{-2.1em}\head{Mutation methods in trait \texttt{mutable.Buffer[A]}, \texttt{ArrayBuffer[A]}, \texttt{ListBuffer[A]}    }\Newline%
\vspace*{-0.5em}%
...
\texttt{xs.filterInPlace(p)} & Filter in place, keep elems that satisfy p. Returns xs itself. \\\cline{1-2}
