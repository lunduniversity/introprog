...
\title[Föreläsningar \CourseCode pgk, Björn Regnell, \today]{\CourseCode~Programmering, grundkurs}
\subtitle{\ifswedish Föreläsningar\else Lectures\fi}
