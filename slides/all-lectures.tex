...
\title[Föreläsningar pgk, \CurrentYear]{Programmering, grundkurs}
\subtitle{Föreläsningar \CurrentYear}
...
\input{body/lect-w07-seq-java-for.tex}
\input{body/lect-w07-stringbuilder.tex}
%\input{body/lect-w07-scanner.tex}
\input{body/lect-w07-random.tex}
