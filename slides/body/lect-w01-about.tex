...
\ifkompendium\else
\begin{SlideAdmin}{Veckoöversikt}
\noindent\resizebox{0.9\columnwidth}{!}{
\input{../plan/overview-generated.tex}
}
\end{SlideAdmin}
...
\ifkompendium\else
\begin{SlideAdmin}{Kursutveckling och förnyelse}
\begin{itemize}
...
\begin{SlideAdmin}{Historik förstaspråk på D vid LTH}
...
\begin{SlideAdmin}{Varför Scala + Java som förstaspråk?}
\begin{itemize}
\item Varför Scala?
\begin{itemize}
...
\ifkompendium\else
\begin{SlideAdmin}{Kurslitteratur}
...
\begin{SlideAdmin}{Beställning av kompendium och snabbreferens}\SlideFontSmall
\begin{itemize}
...
\begin{SlideAdmin}{Föreläsningsanteckningar}
\begin{itemize}
...
\ifkompendium\else
\begin{SlideAdmin}{Personal \CurrentYear}\SlideFontSmall
\begin{description}
...
\ifkompendium\else
\begin{SlideAdmin}{Detta är bara början... }
...
%%%
\begin{SlideAdmin}{Förkunskapsenkät}
\begin{itemize}
...
\begin{SlideAdmin}{Samarbetgrupper}\footnotesize
\begin{itemize}
...
%%%
\begin{SlideAdmin}{Varför studera i samarbetsgrupper?}
...
\begin{SlideAdmin}{Samarbetskontrakt}
...
\begin{SlideAdmin}{Bestraffa inte frågor!}
\begin{itemize}
...
%%%
\begin{SlideAdmin}{Plagiatregler}
\begin{itemize}
...
\ifkompendium\else  %%%%%%%%%%%%%%%%%%%%%%%%%
%%%
\begin{SlideAdmin}{Övningar}\SlideFontSmall
\begin{itemize}
...
\begin{SlideAdmin}{Laborationer}\SlideFontSmall
\begin{itemize}
...
%%%
\begin{SlideAdmin}{Resurstider}\SlideFontTiny
\begin{itemize}
