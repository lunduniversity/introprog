...
\ifkompendium\else
\begin{SlideExtra}{Vem ska gå pgk?}
  \begin{itemize}
    \item D1: Nybörjare på Datateknik, kursen är obligatorisk men du skulle ändå ha registrera dig i Ladok och svarat på upprop i Canvas! Om du inte gjort det kontakta studievägledare: \url{mailto:asa_k.nilsson@lth.lu.se}
    \item Dx: Andra LTH-studenter som bytt till Datateknik
    \item W: Ekosystemteknikstudenter årskurs 3 (eller senare) som vet allt om hur man pluggar på LTH (respect)
...
\begin{SlideExtra}{Viktiga länkar}
  \begin{itemize}
    ...
    \item[]  
    \item Kursens \Alert{slutna} sida bakom inloggingsvägg: \url{https://canvas.education.lu.se/courses/7756}
    \item[] Här finns administrativ information om efterbeställnig av bokpaket, gruppindelning, föreläsningsdeltagarlista, hemlig invajt till Discord-server etc. 
...
\begin{SlideExtra}{Corona-anpassning}
  \begin{itemize}
    ...
    \item Föreläsningar ges i \Alert{hybrid}-form: max 50 får närvara i E:A enligt inbjudan (rullande schema i Canvas), resten deltar online. Föreläsningarna spelas in. Vi kan med kort varsel behöva gå över till enbart online, tex pga ändringar i smittläget. Håll koll på anslag i Canvas.
  \end{itemize}
\end{SlideExtra}
\fi
...
\end{tabular}
\end{table}
\pause\vfill{\SlideFontTiny \Emph{Scalas uppfinnare} \Alert{Professor Martin Odersky} vid EPFL i Lausanne, Schweiz, har även skrivit stora delar av Java-kompilatorn, och var en gång i tiden doktorand för Prof. Niklaus Wirth, som låg bakom Algol, Pascal, Modula m.m.}
\end{SlideExtra}
...
\hskip1.33em\includegraphics[width=0.35\textwidth]{../img/compendium-cover-part1-2020.png}%
~~~\includegraphics[width=0.348\textwidth]{../img/compendium-cover-part2-2020.png}
\begin{itemize}
\item \Emph{Kompendium}\\med övningar \& laborationer, \\trycks till självkostnad enl. beställning,\\se info bakom Canvas-väggen: \url{https://canvas.education.lu.se/courses/7756}
...
\item \Emph{Tentamen}: \Alert{obligatorisk}, skriftlig (??? Corona), enda hjälpmedel: snabbreferensen.\url{http://cs.lth.se/pgk/quickref}
\end{itemize}
\end{Slide}
