...
\begin{SlideExtra}{Vem går pgk?}
  \begin{itemize}%\SlideFontSmall
    \item D1|C1: Nybörjare på Datateknik|Infocom, kursen är obligatorisk men du ska ändå \Alert{självregistrera dig i Ladok}.
...
\item Med anledning av AI-genombrottet vintern 2026: Ökat fokus på din \Emph{individuella förmåga} och \Alert{kontinuerlig verifiering} av din utveckling. ''Muntaträning'' (erbjuds varje vecka, formell uppföljn. w04, w08)
...
\item Kursmaterialet är \Emph{öppen källkod} och \Alert{fritt} tillgängligt. Du är hjärtligt välkommen att bidra! Se instruktioner i kompendiet. \Emph{Studentmedverkan} i kursutvecklingen:
\begin{itemize}\SlideFontTiny
...
\Alert{UTHÄMTNING av beställda men ej uthämtade bokpaket sker på CS expedition 2:a vån E:2179 (ovanför E:B) på föreläsningsraster.}
\begin{itemize}
\item \Alert{Se info i Canvas}. Beställning av tryck är bindande.
\item Kompendiet och snabbreferens trycks här i E-huset och säljs av institutionen till \Emph{självkostnadspris}. För efterbeställning se Cavnvas.
...
\item Swischa vid uthämtning enl. instruktioner i Canvas.
...
\begin{itemize}
\item Föreläsningbilder uppdateras under kursens gång, se hemsida. Använd Shift+Ctrl+R för omladdning vid ändring.
...
Axel Edlund (AXE), 
Axel Friberger (AXF), 
Clara Berglund Hiltunen (CLB), 
David Agardh (DAA), 
Edward Johansson (EDJ), 
Emil Molin (EMM), 
Erik Ekberg (ERE), 
Erling Wesser (ERW), 
Felix Andersson (FEA), 
...
Malte Cedervall (MAC), 
Maria Kulesh (MAK), 
Marina Frid Cardoso (MAF), 
Nils Melén (NIM), 
Pontus Sjöstedt (POS), 
Samuel Jollivet (SAJ), 
Sofia Giding (SOG), 
Valter Bergstrand (VAB), 
Viggo Bergdahl (VIB), 
William Sonesson (WIS)
...
\item \Emph{Laborationer}: \Alert{obligatoriska}, sätta samman teorins delar i ett större program; lösningar redovisas för handledare; gk på alla för att få munta.

\item \Emph{Resurstider}: få hjälp med övningar och laborationsförberedelser av handledare, fråga vad du vill. 

\item \Emph{Kontinuerlig Muntaträning}: verifiera din individuella kodningsförmåga, konceptförståelse och utvecklingen av din pluggteknik.


\item \Emph{Samarbetsgrupper}: grupplärande genom samarbete, hjälp alla att förstå.
...
\item \Emph{Muntligt prov}: \Alert{obligatoriskt}, ska klaras för godkänt på kursen; du visar att du har tillräcklig förmåga och förståelse för att klara nästa kurs. 

\item \Emph{Tentamen}: Valfri för överbetyg. Alla uppmuntras att försöka! Du måste vara godkänd på alla obligaotriska moment för att få tenta. Tentan görs med papper, penna och snabbreferensen som enda hjälpmedel. Anmälan krävs.
\end{itemize}
\end{Slide}
...
\begin{itemize}
\item Pedagogisk forskning visar att lärandet blir mer djupinriktat om det sker i utbyte med andra.
...
\item Du ska stänga av AI-tillägg (Copilot etc.) i VS Code  när du arbetar med denna kurs -- fråga handledare hur.\footnote{Disable AI/Copilot: \url{https://stackoverflow.com/questions/75377406}}
...
\item Gör \Emph{muntaträning} med veckans begrepp och kodskrivningsuppgifter i dialog med handledare.\\\url{https://fileadmin.cs.lth.se/pgk/muntabot/}
...
\item Till de flesta övningar finns \Emph{facit}. Titta inte på facit förrän du \Alert{själv} gjort ett försök. Det finns ofta många olika sätt att åstadkomma samma sak, och din lösningsvariant kan vara lika bra som den i facit -- använd REPL för att verifiera att din lösning fungerar. Diskutera med en \Emph{människa} om du är osäker på vad som är en mer eller mindre bra lösning. Lärare (föreläsare, handledare) och kursmaterialet är bästa källan.
...
\item Blir du \Emph{sjuk} eller har annat giltigt förhinder?\\ Anmäl det \Alert{snarast} till \url{bjorn.regnell@cs.lth.se} (prog) eller \url{mattias.nordahl@cs.lth.se} (dod), \\ få hjälp på resurstid och redovisa helst på resurstid (eller labbtid, om handledaren har tid över)
...
\item Håll ditt \Emph{framstegsprotokoll} uppdaterat på \Alert{papper} med handledarunsderskrifter. Detta är din backup.
