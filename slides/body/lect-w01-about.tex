...
\item Pris för kompendium \Alert{beror på hur många som beställer}. Om tillräckligt många köper blir det ca \Emph{200 kr} inkl. snabbreferens annars \Alert{mellan 300 och 400 kr} vid köp av enstaka ex i efterhand.

\item Snabbreferens kostar \Alert{30 kr} %TODO CHECK THIS!
i enstaka ex men \Emph{ingår i paketet} om du beställer kompendium idag.
...
\begin{Slide}{Laborationer}\SlideFontSmall
\begin{itemize}
...
\\OBS! Rensa cachen (Shift+F5) och kolla versionsnummer.
\end{itemize}
\end{Slide}

%%%
\begin{Slide}{Resurstider}\SlideFontTiny
\begin{itemize}
