...
\begin{SlideExtra}{Viktiga länkar}
  \begin{itemize}
    ...
    \item Kursens \Alert{slutna} sida bakom inloggningsvägg: \url{https://canvas.education.lu.se/courses/25824}
...
\SlideImg{Stor spridning i förkunskaper}{../img/survey-2023.png}
...
\item Det är \Alert{INTE} tillåtet att använda \Alert{artificiell intelligens} i arbetet med laborationer och projekt i denna kurs.
\end{itemize}
