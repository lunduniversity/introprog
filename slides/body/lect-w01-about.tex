...
\begin{SlideExtra}{Corona-anpassning}
  ...
  \begin{itemize}
    ...
    \item Om du får symptom: delta online, pratar med handledare via Discord. Denna resurs är reserverad för de med symptom/riskgrupp. Om du är frisk så ska du delta på plats. 
...
\item ''Programming in Scala'', Fifth Edition (2021), Martin Odersky, Lex Spoon, and Bill Venners.  
  \item Martin Odersky är upphovspersonen bakom Scala och denna välskrivna bok innehåller en komplett genomgång av Scala-språket med många exempel och tips. ''Fith Edition'' täcker Scala version3. Boken riktar sig till de som redan har kunskap om något objektorienterat språk, t.ex. Java. Det finns ett bra index som gör det lätt att anpassa din läsning efter kursens upplägg. Bokens ca 800 sidor innehåller mycket material som är på en mer avancerad nivå än denna kurs, men du kommer att ha nytta av innehållet i kommande kurser.
