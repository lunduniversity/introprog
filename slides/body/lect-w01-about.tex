...
\begin{SlideExtra}{Viktiga länkar}
  \begin{itemize}
    \item Kursens \Emph{öppna} hemsida: \url{https://cs.lth.se/pgk}
...
\hskip1.33em\includegraphics[width=0.35\textwidth]{../img/compendium-cover-part1-2022}%
~~~\includegraphics[width=0.348\textwidth]{../img/compendium-cover-part2-2022}
\begin{itemize}
\item \Emph{Kompendium}\\med övningar \& laborationer, \\trycks till självkostnad enl. beställning,\\se info bakom Canvas-väggen.
\item Föreläsningsbilder på kurshemsidan \\
 \url{https://cs.lth.se/pgk/}
\item Nätresurser enl. länkar i kursmaterialet

\end{itemize}
\end{minipage}
\hskip1em\begin{minipage}{0.35\textwidth}\SlideFontSize{8}{10}
Bra extra \Alert{överkursläsning}:\\
-- för \Emph{nybörjare}:
\vskip0.2mm
...
\vskip0.7mm
\includegraphics[width=0.45\textwidth]{../img/pinsbook}\hskip4mm
%\includegraphics[width=0.47\textwidth]{../img/koffmanbook.jpg}
\\Se \url{https://cs.lth.se/pgk/litteratur/}
\end{minipage}
\end{SlideExtra}
\fi
...
\item \url{https://cs.lth.se/pgk/foerelaesningar/}
...
\item \Emph{Tentamen}: Valfri för överbetyg men alla uppmuntras att försöka; skriftlig, enda hjälpmedel: snabbreferensen.\url{https://cs.lth.se/pgk/quickref}
\end{itemize}
\end{Slide}
...
% \item Gruppindelning publiceras här, obs vänta på v1.0, Ctrl+F5: \\ \url{https://cs.lth.se/pgk/grupp}
% \item Ditt gruppnummer (t.ex. D1.7b) styr vilken schema grupp du tillhör (t.ex. D1.7), se \url{https://cs.lth.se/pgk/schema/timeedit/}
% \end{itemize}
% \end{SlideExtra}
...
\end{enumerate}
Se detaljerna och undantagen i schemat: \href{https://cs.lth.se/pgk/schema}{cs.lth.se/pgk/schema}
\end{Slide}
...
\item Laborationstiderna är gruppindelade enligt \href{https://cs.lth.se/pgk/schema/}{schemat}. Du ska gå till den tid och den sal som motsvarar din grupp som visas i \href{https://cs.lth.se/pgk/schema/timeedit/}{TimeEdit}.\\
\item \Emph{Du hittar vilken grupp du tillhör i Canvas.}
% \Emph{Gruppindelning} blir ''klar'' senast i morgon tisdag kl 13.
% \\Nya versioner släpps här: \url{https://cs.lth.se/pgk/grupp}
...
% \item Kom till minst en resurstid per vecka, se \href{https://cs.lth.se/pgk/schema/timeedit}{Schema i TimeEdit}.
...
%   \item Ladda ner vm hemma (\Alert{inte} över eduroam för det är 5GB och tar en evighet): \url{https://cs.lth.se/pgk/vm}
...
%   \item Mer info finns i Appendix K i \href{http://fileadmin.cs.lth.se/pgk/compendium.pdf}{compendium.pdf} 
%   \end{itemize}
% \end{SlideExtra}
% \fi
...
%   \item Beställning av \Alert{bokpaket} om du inte redan gjort det \url{https://cs.lth.se/pgk/bokpaket}
%   \item Fyll i \Alert{förkunskaper} om du inte redan gjort det \url{https://cs.lth.se/pgk/introsurvey}
%   \item ...
% \end{itemize}
% \end{SlideExtra}
% \fi
