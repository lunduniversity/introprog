...
\item Du ska stänga av tillägget Copilot i VS Code  när du arbetar med denna kurs -- fråga handledare hur.\footnote{Disable copilot: \url{https://stackoverflow.com/questions/7537740}}
\item Att värdera kvaliteten på AI-genererad kod kräver djup kunskap. Därför väntar vi till senare kurser med att träna på att använda AI för kodgenerering.
