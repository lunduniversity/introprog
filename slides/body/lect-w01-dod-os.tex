...
\begin{Slide}{Filer i Unix/Linux}
    ...
    \textbf{Man lagrar program och data i \emph{filer}, som har ett namn.}

    \halfblankline
    \textbf{Filer ligger alltid i en katalog (mapp).}

    \halfblankline
    \textbf{Filer och kataloger lagras på \enquote{permanent} minne (hårddisk, SSD, \ldots).}

    \halfblankline
    \textbf{Filnamn i Unix/Linux:}

    \begin{itemize}
        \is{\texttt{namn.tillägg} (\texttt{Calc.scala}, \texttt{Calc.class}, \texttt{brev.txt}, \texttt{test1}, \ldots)}
...
%         \resizebox{!}{0.7\textheight}{\input{lect-w01-dod-file-tree.tex}}
%     \end{center}
...
% \end{Slide}
\begin{Slide}{Filnamn och sökvägar}
...
\begin{Slide}{Kommandotolk (shell, ''skal'') och terminal}
    ...
    \textbf{Exempel på kommandotolkar:}
    \begin{itemize}
...
\end{Code}
    ...
    \halfblankline
        \begin{tabular}{lp{60mm}}
            \texttt{scalac Calc.scala}        & Kompilerar \texttt{Calc.scala} med Scalakompilatorn                                                                                             \\
...
\textbf{Filskydd kan anges symboliskt, till exempel \texttt{u=rw,o=r}}

\halfblankline
\textbf{Eller numeriskt, enligt:}
...
\textbf{Fullständiga numeriska filskydd blir till exempel:}
...
\begin{Slide}{Initieringsfiler}
    ...
    \textbf{\texttt{bash} initieringsfil:}
    \begin{itemize}
...
\begin{Slide}{Fönstersystem, skrivbordsmiljö}
    \textbf{Fönstersystem:}
    \begin{itemize}
