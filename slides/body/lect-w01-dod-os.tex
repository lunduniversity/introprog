...
\begin{Slide}{Välkommen till Datorer och datoranvändning (dod)}
  \begin{itemize}
    \item \ifswedish Syftet med \emph{dod}-delen?\else Purpose of the \emph{dod} part?\fi
          \begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Laborationer
          \begin{itemize}
            ...
            \item Laboration 1, Linux (Första laborationen denna vecka!)
            \item Laboration 2, Maskinkod
            \item Laboration 3. \LaTeX (LP 2)
            \item Laboration 4, Git och Github (LP 2)
          \end{itemize}
  \end{itemize}
\end{Slide}
...
\begin{itemize}\SlideFontSmall
    ...
    \ii{data (foton, dokument, programmeringsuppgifter, \ldots)}
\end{itemize}
...
\begin{Slide}{Kataloger}
    ...
    \begin{center}
        \resizebox{!}{0.5\textwidth}{\input{../slides/body/lect-w01-dod-file-tree.tex}}
    \end{center}
\end{Slide}
...
\begin{Slide}{Kommandon för filhantering}\SlideFontSmall
    ...
    \begin{tabular}{lp{7.0cm}}
        ...
        \texttt{ls [-la] kat}  & Skriv ut en innehållsförteckning över katalogen \texttt{kat} (aktuell katalog om ingen katalog ges). \texttt{-l} skriv i ett längre format, \texttt{-a} skriv också ut punktfiler. Hakparenteserna indikerar att optionerna är valfria. \\
...
\end{Code}
    ...
    Första tecknet är antingen \texttt{-} (vanlig fil) eller \texttt{d} (katalog).
...
\begin{Slide}{bash-finesser 1} \SlideFontSmall
    ...
    \begin{tabular}{p{2.2cm}p{8cm}}
        ...
        \commandchar{Ctrl+K}                      & Radera hela raden.                                                        \\
        \commandchar{Ctrl+U}                      & Radera allt till vänster.                                                 \\
        \commandchar{Ctrl+L}                      & Töm terminalfönstret.                                                     \\
...
\begin{Slide}{Vad är egentligen ett kommando?}
    ...
    \begin{description}
        % Saknas mellanrum mellan 'Inbyggda' och 'Kör ...'
