...
\begin{Slide}{Förberedelse inför laboration 1.}
    \label{unix}
...
%     ... opinionsundersökning i mentimeter...
...
% \end{Slide}
\begin{Slide}{Förkortade filnamn}
    ...
    \ts{Om \texttt{\url{~}/dod/lab1} är aktuell katalog:}
...
% \end{Slide}
\begin{Slide}{Kommandotolk (shell) och terminal}
...
\ti{Filskydd kan anges symboliskt, till exempel \texttt{u=rw,o=r}}
...
\begin{Slide}{Initieringsfiler}
    ...
    \ti{\textbf{\texttt{bash} initieringsfil:}}
    \begin{itemize}
...
gedit example.txt &
\end{Code}
    \ti{\textit{Öppnar \texttt{gedit} i bakgrunden, terminalen blir omedelbart tillgänglig för nya kommandon.}}
