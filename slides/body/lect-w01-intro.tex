...
\includegraphics[width=0.85\columnwidth]{../img/redmonk-Q321}
\end{SlideExtra}
...
\item Få hjälp att kompilera och köra med \Emph{byggverktyget \texttt{sbt}}
\item Integrerad utvecklingsmiljö (IDE)
\begin{itemize}
\item \Emph{Kojo}: på lab 1
...
\item Kojo som används på veckans lab kör ännu Scala 2, så du behöver använda gamla syntaxen för kontrollstrukturer i Kojo.
