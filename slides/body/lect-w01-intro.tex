...
\ifkompendium\else  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{SlideAdmin}{Att lära denna läsvecka \texttt{w01}}
...
\begin{SlideAdmin}{Att skapa koden som styr världen}
...
\begin{SlideAdmin}{Utveckling av mjukvara i praktiken}
\begin{itemize}
...
\noindent Grace Hopper uppfann första kompilatorn 1952.\\
...
\ifkompendium\else
\begin{SlideAdmin}{Redmonk Language Rankings: Github, Stackoverflow}
...
\item \Emph{Texteditor} för kod, t.ex \code{atom}: från övn 2
...
\item \Emph{ScalaIDE/Eclipse} eller \Emph{IntelliJ IDEA}: från läsperiod 2
\end{itemize}
...
\begin{SlideAdmin}{Om veckans övning: \code{expressions}}\SlideFontSmall
...
\begin{SlideAdmin}{Om veckans labb: \code{kojo}}
\begin{itemize}
