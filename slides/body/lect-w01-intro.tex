...
\TODO\includegraphics[width=0.85\columnwidth]{../img/redmonk-Q320}
\end{SlideExtra}
...
% \pause
% \noindent Scala-applikation med fullständig \code{def main} i ett objekt:
% \begin{Code}
% object Hello:
...
\end{itemize}
Skriv ett uttryck när du är intresserad av \Emph{värdet} som beräknas.\\
Skriv en sats när du vill att något ska \Alert{göras}.\\~\\
\end{Slide}
...
I Scala 2 användes en ''gammal'' syntax för kontrollstrukturer som liknar mer C/C++/Java. Den är tillåten i Scala 3, men nya syntaxen är lättare att föredra.
\begin{itemize}
...
println("Repetitionen är klar!")
\end{Code}
Då är det \Emph{intenteringen} som avgör vilka satser som ingår. \\Detta fungerar i Scala 3 (men inte i Scala 2).
\end{Slide}
