...
\item I augusti 2024 blev \Alert{\texttt{scala-cli}} det nya \Emph{\texttt{scala}}-kommandot. Från scala 3.5 kan du ersätta alla förekomster av \code{scala-cli} med det kortare \code{scala}.
