...
\begin{Slide}{Installera verktyg på din egen dator}
  ...
  \begin{itemize}
    ...
    \item Se instruktioner här: \url{https://cs.lth.se/pgk/verktyg}
...
\item I augusti 2024 blev \Alert{\texttt{scala-cli}} det nya \Emph{\texttt{scala}}-kommandot.\footnote{När kompendiet trycktes hade skiftet ännu inte skett. Nu kan du ersätta alla förekomster av \code{scala-cli} med det kortare \code{scala}.}
...
\item En identifierare får \Alert{inte} vara ett \Emph{reserverat ord}, se \href{https://cs.lth.se/pgk/quickref}{snabbreferensen} för alla reserverade ord i Scala.
