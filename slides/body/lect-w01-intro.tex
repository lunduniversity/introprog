...
\begin{itemize}
  ...
  \begin{enumerate}
  \item Grafikbiblioteket i \textbf{\texttt{kojo}} i ett fristående Scala program med hjälp av en professionell kodeditor och kompilering och exekvering i terminalen. \Emph{Fungerar fint med nya Scala 3}.
