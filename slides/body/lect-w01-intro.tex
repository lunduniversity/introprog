...
val res2: Int = 20
\end{REPL}
\item \Emph{Moduloräkning} med restoperatorn \texttt{\%} ger resten vid vid heltalsdivision:
\begin{REPL}
scala> 41 % 2
val res3: Int = 1               // resten är 41 - 2 * (41 / 2) == 1
\end{REPL}
Läs mer om moduloräkning här: \href{https://sv.wikipedia.org/wiki/Modul%C3%A4r_aritmetik}{sv.wikipedia.org/wiki/Modulär\_aritmetik}
\end{itemize}
\end{Slide}
