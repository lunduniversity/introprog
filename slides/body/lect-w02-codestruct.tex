...
\begin{itemize}
\item Scala-kod kan köras som ett \Emph{skript}.\footnote{\SlideFontTiny Du får prova detta på övningen. Vi kommer mest att köra kompilerat i kursen, då Scala-skript saknar mekanism för inkludering av andra skript. Men det finns ett öppenkällkodsprojekt som löser det: \url{http://www.lihaoyi.com/Ammonite/}
}
...
\begin{algorithm}[H]
 ...
 \Input{heltalet $n$}
 \Output{utskrift av produkten av de första $n$ positiva heltalen}
 ~\\
 $prod \leftarrow 1$ \\
 $i \leftarrow 2$  \\
 \While{$i \leq n$}{
...
\begin{itemize}
  ...
  \item Funktioner ger ett booleskt värde kallas för \Emph{predikat}.
\end{itemize}
