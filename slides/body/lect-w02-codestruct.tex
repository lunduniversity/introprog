...
\begin{SlideExtra}{Öppna en projektkatalog med kodfiler i din kodeditor}
  \begin{itemize} \SlideFontSmall
    ...
    \item Du behever också explicit klicka ''Trust'' när VS Code frågar om detta. Om du inte har gjort det så finns en blå knapp ''Restricted...'' nere till vänster och ingen kompilering/körning innifrån VS Code funkar. Detta krävs för att du ska tänka efter innan du råkar köra elak kod... 
  \end{itemize}
\end{SlideExtra}
