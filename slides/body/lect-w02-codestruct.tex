...
\begin{REPL}
> scala-cli run helloargs1.scala -- morot gurka tomat
morot
gurka
tomat
\end{REPL}
...
Kompilera och kör med programargument efter \code{--}
\begin{REPL}
> scala-cli run helloargs2.scala -- 2 morot gurka tomat
morot
gurka
> scala-cli run helloargs2.scala -- aj morot gurka tomat
...
\begin{itemize}
  \SlideFontSmall
  \item 
Scala-kod kan köras som ett \Emph{skript}.\footnote{\SlideFontTiny En nackdel med Scala-skript är att de ej kan inkludera skript i andra kodfiler.
}
