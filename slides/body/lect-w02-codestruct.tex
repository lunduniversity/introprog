...
\begin{SlideExtra}{Repetition: \texttt{val} \texttt{var} \texttt{def}}
  ...
  \begin{itemize}
    \item Med \code{val} deklarera variabel som tilldelas ett värde vid initialisering och ändras sedan aldrig.
    \item Med 
  \end{itemize}
  En konstighet i REPL: \\ Man kan deklarera variabler och funktioner med samma namn flera gånger -- det är i normala fristående program ett \Alert{kompileringsfel.} 
\end{SlideExtra}
\fi 
