...
\end{itemize}
Om du inte hann klart labben, fortsätt på egen hand och på resurstid. \Alert{Avsätt mer tid till labbförberedelser nästa gång}. Gör grundövningarna före labben.
\\ 
\Alert{Glöm inte} att du ska få labbhandledarens \Alert{underskrift} i protokollet i början av kompendiet när du är \Emph{närvarande} (godkänd eller kompletteras).
\end{SlideExtra}
...
Läsvecka 2:
\begin{itemize}
\item Övning \texttt{\ExeWeekTWO}: görs denna vecka! annars blir du efter 
\item \Emph{Ingen prog-labb denna vecka}, (enbart dod-labb c3pu).
\end{itemize}
Läsvecka 3:
\begin{itemize}
...
\vspace{0.5em}\Alert{OBS!} Notera \Alert{schemaavvikelser} -- vissa veckor är annorlunda, se schema i TimeEdit och \href{https://fileadmin.cs.lth.se/pgk/kaptenalloc}{fileadmin.cs.lth.se/pgk/kaptenalloc}.\\
\Alert{Gå till ditt rätta rum enligt schemagrupp i Kapten Alloc!}
...
\begin{itemize}\SlideFontSmall
\item Gör \Emph{grundövningarna} \Alert{innan} du börjar med labben. Dubbelkolla att du har uppnått \Emph{övningsmålen}.
