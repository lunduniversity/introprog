...
\item Om du tror att du behöver det för att hinna med: \\ gör \Emph{delar} av labben \Alert{innan} ditt labbtillfälle.
\end{itemize}
\end{itemize}
...
\begin{Slide}{Nu på rasten: träffa din samarbetsgrupp}
\begin{itemize}
