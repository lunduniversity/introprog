...
\begin{itemize}
  ...
  \item Labbarna är endast godkänd/kompletteras. 
  \item Labbarna påverkar inte slutbetyget men det krävs godkänt på alla labbar för att få tentera.
  \item Att hjälpa varandra i samarbetsgrupperna med labbarna är \Emph{inte} fusk. Men att göra labben åt någon annan \Alert{är} fusk. Hjälp varandra att förstå begrepp och att komma vidare när någon kör fast. Läs kapitel -1 Anvisningar i kompendiet.
\end{itemize}  
\end{SlideExtra}
...
\vspace{1em}\Alert{OBS!} Noter schemaavvikelser för vissa resurstider i läsvecka 4.\\\url{http://cs.lth.se/pgk/schema/timeedit/}
