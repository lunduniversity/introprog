...
\begin{SlideExtra}{Hämta beställda bokpaket!}
  \begin{itemize}
    ...
    \item[] Gå till datavetenskaps \Emph{expedition} på andra våningen i E-huset trapphus A på expeditionstid eller \url{mailto:cs_expedition@cs.lth.se} \\ för överenskommelse om annan tid. 
  \end{itemize}
\end{SlideExtra}
