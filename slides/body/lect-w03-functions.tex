...
\end{REPLnonum}
  ...
  \url{https://msdn.microsoft.com/en-us/commandline/wsl/install_guide} \\
  Välj varianten längre ner med \code{lxrun} så slipper du bli "windows insider" med allt vad det innebär.
\end{itemize}
\end{Slide}
