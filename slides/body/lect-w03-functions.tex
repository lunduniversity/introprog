...
\begin{itemize}
  \item Abstraktion innebär att skapa en förenklad \Emph{modell} ur konkreta detaljer 
  ...
  \item Funktioner (som du redan känner från matematiken) är en av våra \Alert{viktigaste} abstraktionsmekanismer
\end{itemize}
