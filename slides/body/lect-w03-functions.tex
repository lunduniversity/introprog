...
\item \Emph{anonyma funktioner} (''lambda'') går att göra med specifika begränsningar i Java 8. \href{https://en.wikipedia.org/wiki/Anonymous_function\#Java_Limitations}{en.wikipedia.org/wiki/Anonymous\_function\#Java\_Limitations}
