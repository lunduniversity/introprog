...
\item Senaste versionen av kursbiblioteket \code{introprog} är $1.1.4$ och jar-filens namn är \href{http://cs.lth.se/pgk/lib}{\code{introprog_2.12-1.1.4.jar}} \\Se dokumentation här: \url{http://cs.lth.se/pgk/api}
\end{itemize}
\end{SlideExtra}
\fi
...
\begin{itemize}
\item Jarfilen \code{introprog_2.12-1.1.4.jar} innehåller paketet \code{introprog} som bl.a. innehåller klassen \code{PixelWindow}.
...
\item Ladda ner \url{http://cs.lth.se/pgk/lib} och lägg sedan jar-filen i den katalog där du startar REPL med: \code{scala -cp introprog_2.12-1.1.4.jar}
\end{itemize}
%\pause
\begin{REPLnonum}
