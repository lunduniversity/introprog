...
\begin{itemize}
\item I JDK8 (Java Development Kit version 1.8) finns 217 paket (moduler) och 4240 färdiga klasser.\footnote{\url{https://stackoverflow.com/questions/3112882/how-many-classes-are-there-in-java-standard-edition}} 

\item En av dessa klasser heter \code{Color} och ligger i paketet \code{java.awt} och används för att representera RGB-färger med  heltalsattribut som beskriver andelen Rött, Grönt och Blått.
\end{itemize}
\begin{REPL}
...
scala> Color.    // tryck TAB och se alla publika medelmmar
\end{REPL}
