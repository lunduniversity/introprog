...
\begin{itemize}
  ...
  \item använda färdig klass i jar-fil: \code{introprog.PixelWindow}
...
På labben ska du använda \code{introprog.PixelWindow}
\begin{itemize}
...
\end{Code}
Första gången du kör \code{compile}, \code{run} eller \code{console} i \code{sbt} kommer paketet \code{introprog} automatiskt att laddas ner från webbplatsen \Emph{Sonatype Maven Central} där många öppenkällkodspaket finns fritt tillgängliga.
\end{Slide}
