...
\begin{Slide}{Färdiga grafikmetoder i klassen \texttt{PixelWindow}}
  \TODO -classpath funkar för tillfället inte med REPL - ska vi gå över helt till sbt och skippa övningar med classpath?
  \\
...
\begin{Code}
scalaVersion := "3.0.0"    // ange version av Scala-kompilatorn
\end{Code}
