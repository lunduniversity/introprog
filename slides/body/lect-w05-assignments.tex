...
\begin{SlideExtra}{Lab \texttt{blockbattle} redovisas NÄSTA läsvecka 6}
  ...
  \begin{minipage}{0.59\textwidth}
    \begin{itemize}\SlideFontTiny
      ...
      \item Programmet är \Alert{väsentligt mer omfattande} jämfört med tidigare laborationer.
      ...
      \item OBS! Labbtider är schemalagda som vanligt under läsvecka 5, men fungerar som resurstider och är \Emph{inte} obligatoriska. Utnyttja undervisningen på ett sätt som gör att du \Alert{maximerar} ditt lärande.  
    \end{itemize}    
  \end{minipage}
\end{SlideExtra}
