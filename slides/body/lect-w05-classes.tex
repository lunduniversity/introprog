...
\begin{itemize}
\item Klassparametrar blir automatiskt publika oföränderliga attribut\footnote{alltså \Alert{inte} instansprivat } som i vanliga klasser.} och du slipper alltså skriva \code{val}
