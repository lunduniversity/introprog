...
\begin{Slide}{Exempel: singelobjekt jämfört med klass}\SlideFontSmall
...
%%%%%%%%%%%% TODO EXEMPEL KOMPLEXA TAL ÄR FÖR SVÅR MATEMATIK för lp1 %%%%%%%%%
...
\begin{Slide}{Exempel: \texttt{private} jämfört med \texttt{private[this]}}\SlideFontSmall
...
\item I Scala \Emph{kan} man också skriva egna alternativa s.k. \Emph{hjälpkonstruktorer}, men det är \Alert{ovanligt}, eftersom man har möjligheten med fabriksmetoder i kompanjonsobjekt och default-argument (saknas i Java).
\end{itemize}
\end{Slide}
...
$ javac JComplex.java
$ scala
Welcome to Scala 2.12.6 (Java HotSpot(TM) 64-Bit Server VM, Java 1.8.0_66).
