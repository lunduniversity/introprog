...
\TODO förklara domän, data, modell, datamodell; klasser är viktig abstraktionsmekanism för att modellera data, men det finns andra \code{Int}, \code{String} etc., \code{enum}
\end{Slide}
