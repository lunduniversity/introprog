...
\begin{Slide}{Fördjupning: Multiversell likhet i Scala 3}
\begin{itemize}
  \item \Alert{Problem}: \code{equals} tar värden av vilken typ som helst.
  \item I Scala 3 finns möjlighet att få typ-säker likhetstest.
  \item Läs mer här om du är nyfiken och vill prova: \url{https://docs.scala-lang.org/scala3/reference/contextual/multiversal-equality.html}
