...
\begin{itemize}\SlideFontSmall
\item Exempel: För de orelaterade typerna \code{String} och \code{Double} är den mest specifika typen som kan härledas \code{Int | String}, läses ''Int eller String'' och kallas en \Emph{unionstyp} \Eng{union type}.
