...
\code{unapply} genereras av kompilatorn och används internt vid matchning och det är det som gör att case-klasser kan användas i konstruktormönster. \\Principen är generell: Man kan skapa en egna s.k. extraktorer \Eng{extractors} som funkar i matchningar genom att definiera en egen \code{unapply}.
\end{Slide}
