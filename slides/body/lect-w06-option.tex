...
\draw[umlarrow] (SubType1.north) -- ++(0,0.6) -| (BaseType.south);
\draw[umlarrow] (SubType2.north) -- ++(0,0.6) -| (BaseType.south);
\end{tikzpicture}
\end{center}
\pause
...
\begin{Slide}{Option för hantering av ev. saknade värden}\SlideFontTiny
...
\begin{Slide}{Några smidiga metoder på \texttt{Option}}\SlideFontSmall
...
\begin{Slide}{Några samlingsmetoder som ger en \texttt{Option}, övning}
\begin{REPLsmall}
...
\begin{Slide}{Några samlingsmetoder som ger en \texttt{Option}, svar}
\begin{REPLsmall}
scala> val (xs, ys) = (Vector(1,2,3), Vector())
