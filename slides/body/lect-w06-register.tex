...
\begin{Slide}{Syresättning av hjärnan med registreringslek}\SlideFontTiny
...
object StandUpSleepyBrain {
  def randomChar: Char = (scala.util.Random.nextInt('Z' - 'A') + 'A').toChar
  val reg = new Array[Int]('Z' - 'A')
...
\end{Code}
\vspace{-0.65em}Kör koden medan du lyssnar till: \href{https://youtu.be/ZVrgj3A0_BY}{https://youtu.be/ZVrgj3A0\_BY}
\end{Slide}
