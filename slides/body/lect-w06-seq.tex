...
\pause
\item Några ofta återkommande programmeringsproblem som löses med en sekvensalgoritm:
\begin{itemize}\SlideFontSmall
...
\end{Code}
Hur implementera dessa med \code{for}-uttryck och/eller färdiga samlingsmetoder?
\end{Slide}
...
Genom att generalisera funktionshuvudena blir våra lösningar mer användbara.
\begin{Code}
