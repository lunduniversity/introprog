...
\end{REPLnonum}
\pause
\item Semantik: operatornotation med operartorer som \Emph{slutar med kolon} är \Alert{högerassociativa}
...
Genom att generalisera funktionshuvudena blir våra lösningar användbara för \Alert{alla} skevenser av typen \code{Seq[T]}.
\begin{Code}
