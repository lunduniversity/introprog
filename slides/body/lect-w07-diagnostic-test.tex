...
\begin{Slide}{Beställning av tryck av kompendium lp 2}\SlideFontTiny
\Emph{Mejl som skickats till alla:}
\begin{verbatim}
Hej alla!
...
/B
\end{verbatim}
\Alert{Det är himla bra att ha kompendiet på papper, bredvid skärmen speciellt när du jobbar med en IDE med massor av fönster!!}
\end{Slide}
