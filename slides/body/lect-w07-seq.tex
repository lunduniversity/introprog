...
Typen \Emph{\code{collection.immutable.Seq}} är supertyp till alla sekvenssamlingar i\\\code{collection.immutable} vilken gör typen \code{Seq} mer generellt användbar.\\
