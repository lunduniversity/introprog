...
\item \Emph{Uppdatering} av sekvensen: ta bort, lägga till, byta ut enskilda element
\item \Emph{Transformering}: applicera en \Alert{funktion} på alla element   
...
{
  \setbeamercolor{background canvas}{bg=black}
  \frame[plain]{\centering\Huge\textbf{\color{pink}{ORDNINGEN}\\SPELAR\\ROLL\\KUTFSSR}}
}
\fi
