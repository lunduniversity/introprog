...
\item \ifswedish Kompileringsfel -- tack kompilatorn!\else Compilation errors -- thank the compiler!\fi
\item Exekveringsfel \pause 
\begin{itemize}
\item Exekveringen ger oönskat resultat 
\begin{itemize}
\item \ifswedish Vid testning -- eller är det fel på testfallet?\else When testing -- or is the test case wrong?\fi
