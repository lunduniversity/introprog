...
\item En typparameter är \Emph{fri} om den \Alert{inte} fått något värde i omslutande deklarationer, annars \Emph{bunden}. Exempel: \Emph{generisk} funktion:
\end{itemize}
\begin{Code}
...
%\TODO 
\begin{itemize}
\item Läs om testning och avlusning \Eng{debugging} i Appendix \ref{appendix:debug}
