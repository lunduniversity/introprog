...
\item Universum är en matris av \Emph{celler} där \Emph{levande} celler representeras med \code{true} och \Alert{döda} med \code{false}.
\item Följande regler gäller för nästa generation celler i universum:
\begin{itemize}\SlideFontTiny
\item hej
\end{itemize}
\item Du ska implementera \emph{Game of Life} med hjälp av \code{introprog.PixelWindow}
...
\begin{Slide}{Veckans labb: \texttt{life}}\SlideFontSmall
Grunduppgift:
\begin{itemize}
\item Implementera en algoritm som hittar ut ur en labyrint.

\item En labyrint representeras av en \Emph{matris}, \\närmare bestämt en \Emph{vektor av vektorer} med  \Alert{booleska} värden: \\ \code{Vector[Vector[Boolean]]}
