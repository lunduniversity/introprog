...
\begin{Slide}{Omkontrollskrivning}
  \begin{itemize}
    ...
    % \end{itemize}
    \item \Alert{OMKONTROLLSKRIVNING}\\för de som var frånvarande på ordinarie skrivning med giltigt skäl -- om du INTE meddelat (giltigt) skäl för frånvaro kontakta \url{bjorn.regnell@cs.lth.se} \Alert{omgående}:
    \begin{itemize}
      \item Preliminärt datum för \Emph{uppsamling:} 
