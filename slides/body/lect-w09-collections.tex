...
\begin{itemize}
\item För vanliga förekommande konverteringar finns metoderna \code{toVector}, \code{toSeq}, \code{toArray}, \code{toBuffer}, \code{toMap}, \code{toIndexedSeq}, \code{toSeq}, \code{toList}, \code{toString}
