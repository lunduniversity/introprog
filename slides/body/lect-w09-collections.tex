...
\begin{itemize}
\item För vanligt förekommande konverteringar finns metoderna \code{toVector}, \code{toSeq}, \code{toArray}, \code{toBuffer}, \code{toMap}, \code{toIndexedSeq}, \code{toSeq}, \code{toList}, \code{toString}
...
\item Kan användas till att t.ex. konvertera mellan oföränderlig och föränderlig samling:
\end{itemize}
\begin{REPLnonum}
