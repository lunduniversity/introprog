...
\begin{Slide}{UML-diagram för att beskriva typer och arv}
\begin{center}
\begin{tikzpicture}
...
\node (explain1)[above of = Class, yshift=1cm, text width=4.9cm]{En typ i ett \Emph{UML}-diagram kan ha 3 delar:};
