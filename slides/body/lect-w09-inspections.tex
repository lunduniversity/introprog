...
\begin{Slide}{Att läsa kod} \SlideFontSmall
  ...
  \begin{itemize}\SlideFontSmall
    ...
    \item Vid problemlösning, ställ dig under läsning av befintlig kod dessa \Alert{frågor}: \\ \Emph{''Vad finns?''} och \Emph{''Vad fattas?}'' för att du ska kunna lösa din uppgift.
  \end{itemize}
\end{Slide}
...
\begin{itemize}
\item Bra på att \Emph{upptäcka problem}, även sådana som varken kompilator eller testning hittar.
\item \Emph{Delar kunskap} inom en arbetsgrupp, speciellt mellan erfarna och juniora utvecklare.
\item En god kodgranskningsprocess främjar en kultur av \Emph{gemensamt} ägarskap och respektfull samverkan.
\end{itemize}
\end{Slide}
...
\item Hjälp att bredda ditt perspektiv inför diskussionen med handledare under din individuella redovisning av granskningsarbetet.
