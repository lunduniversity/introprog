...
% \item Förberedelse: kolla på din kontrollskrivning del B och välj ut något specifikt som du vill ha hjälp med att förstå. \\ Kolla ks här: \url{https://cs.lth.se/pgk/examination/}
% \end{itemize}
% \end{Slide}
