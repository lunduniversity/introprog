...
Ett alternativ vore \Emph{komposition}:\\SnakeGame \Alert{har} ett BlockGame\\~\\
%\begin{center}
%\newcommand{\TextBox}[1]{\raisebox{0pt}[1em][0.5em]{#1}}
\begin{tikzpicture}[inner sep=0.5em]
\node [umlclass, rectangle split parts = 2, xshift=0cm, text width=4.8cm] (game)  {
           \textbf{\centerline{\TextBox{SnakeGame}}}
...
\node [umlclass, rectangle split parts = 2, xshift=0cm, text width=4cm] (game)  {
           \textbf{\centerline{\TextBox{Player}}}
