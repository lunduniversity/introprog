...
\pause\item (För att skilja ut s.k. \Emph{opaka typer} (ingår ej i denna kurs), som \Alert{inte} kan undersökas med mönstermatchning, så är finns även typen \code{Matchable} som är subtyp till \code{Any} och supertyp till \code{AnyRef} och \code{AnyVal}.)
\end{itemize}
\end{Slide}
