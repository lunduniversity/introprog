...
\begin{frame}[plain]
    \color{white}{Inkapsling av värden så att krasch kan unvikas vid specialfall!}
    \makebox[\linewidth]{\includegraphics[width=\paperwidth]{../img/crystal.jpg}}
\end{frame}
}
\fi

\Subsection{Hantera \Alert{saknade} värden med \texttt{Option}}
...
\item \code{null} om värde saknas (vanligt i Java, mkt ovanligt i Scala)
