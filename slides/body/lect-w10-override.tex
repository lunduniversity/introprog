...
\ifswedish Med trait, case-klass och objekt:\else With trait, case class and object:\fi
\begin{CodeSmall}
sealed trait PersonalIdentity  // summa
object PersonalIdentity:  
  final case class Id(num: Long, isTemporary: Boolean) extends PersonalIdentity // produkt
  case object Missing extends PersonalIdentity
\end{CodeSmall}
\pause 
\vspace{1em}
...
enum PersonalIdentity:
  case Id(num: Long, isTemporary: Boolean)
  case Missing     
\end{Code}
% \begin{REPLsmall}
