...
\begin{itemize}\SlideFontSmall
  ...
  \item \Emph{Kontextgräns} \Eng{context bound} via given typkonstruktor \code{A: B}. 
  ...
  \item Det finns också något som heter \Emph{kontextgräns} \Eng{context bound}\\-- mer om det senare i avsnittet om kontextuella abstraktioner.
\end{itemize}
\end{Slide}
...
\item Denna lösning kan \Alert{inte} erbjuda \Alert{olika} kontextberoende default-värden; alla funktionsanrop använder \Alert{ett} globalt föränderliga värde. Buggrisk!
\end{itemize}
