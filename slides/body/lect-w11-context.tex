...
\item En typkonstruktor av \code{T}, som har metoder som är \Alert{konsumenter} av \code{T}, kan vara \Emph{kontravariant}, t.ex. \code{case class Veterinär[-T]}
...
\footnote{\SlideFontTiny Funktionstypen \code{A => B} är ''syntaktiskt socker'' -- kompilatorn expanderar detta till \code{Function1[A, B]} }
\end{itemize}
\end{Slide}
