...
\item W12-W13: Projekt \hfill En större individuell labb, gärna \code{bank}.
\item W14: Munta \hfill På schematider endast ons-tors.
\begin{itemize}
\item Om du är väl förberedd för muntan kan du göra den så snart alla labbar utom projektet är klara W11-W13. 
\item Prata med handledare på resurs- el. labbtid.
\item Förbered dig noga med hjälp av \url{https://cs.lth.se/pgk/muntabot}
\item Läs om muntan i kompendiet.
\end{itemize}
\item Se schema: \url{https://cs.lth.se/pgk/schema/}
\end{itemize}
\end{itemize}
\end{Slide}
