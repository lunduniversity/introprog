...
\item Projektet går över \Alert{två veckor}. Schemalagda labbar är obligatoriska dör de som har återstående obligatoriska moment.
...
\end{itemize}
  ...
  \item Föreläsningen kommer även sändas live i Zoom via vanliga pgk-länken.
\end{itemize}
...
\begin{itemize}\SlideFontSmall
  ...
  \item \Alert{OBS! Obligatorisk anmälan} i LTH:s ordinarie tentasystem. Anmälningssystemet är öppet sedan i går och stänger den 15/12. 
\end{itemize}
\end{SlideExtra}
