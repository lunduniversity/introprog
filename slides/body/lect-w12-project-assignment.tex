...
\begin{itemize}
  \item Måndagen den \Alert{4/12 kl 15-17 i E:B} håller Björn Regnell en föreläsning i C:arnas kurs om digitalisering EITA65: 
\begin{itemize}
  \item \Emph{Kravhantering} för mjukvara: hur bestämma vad koda?
  \item Hur bäst dra nytta av \Emph{öppen källkod}?
\end{itemize}
  \item \Alert{D-are, W-are} är också \Emph{hjärtligt välkomna!!!}
\end{itemize}
