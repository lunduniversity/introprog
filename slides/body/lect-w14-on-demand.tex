...
\item Scala 2.13 (2019) fokus på standardbiblioteket och \code{scala.collection}
\item Scala 2.14 (2020) verktyg för migrering till Scala 3.0
\item Scala 3.0~~(2020): \Alert{stort} \Emph{tekniksprång}:\\enum, union types, opaque types, etc.,\\ "uppstädning" + förenklingar baserat på lärdomar från Scala 2.
\end{itemize}
\end{Slide}
