...
\begin{Slide}{Kursmoment --- varför?}\footnotesize
\begin{itemize}
...
\item \Emph{Inlämningsupgift}: \Alert{obligatorisk}, du visar att du kan skapa ett större program självständigt; redovisas för handledare
