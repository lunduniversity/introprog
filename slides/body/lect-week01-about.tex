...
\ifkompendium
\noindent Kursen består av en \textbf{modul} per läsvecka med \textbf{föreläsningar}, \textbf{övningar} och \textbf{laborationer} (undantaget W02, W13 \& W14 som saknar labb och/eller övning). 
Föreläsningarna ger en översikt av den teori som ingår i varje modul. Genom att göra övningarna bearbetar du teorin och förebereder dig inför laborationerna. När du klarat övningen och laborationen i respektive modul är du redo att gå vidare till nästa modul. Tabellen på nästa uppslag visar begrepp som ingår i varje modul. 
