...
\begin{Slide}{Verktyg}
Att kunna verktygen väl är grunden för hög produktivitet. \\Det är värdefullt att lära sig kortkommandon för vanliga handgrep. \\ Verktyg vi använder i kursen:
\begin{itemize}
