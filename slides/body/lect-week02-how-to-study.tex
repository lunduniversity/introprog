...
\pause\item Det är svårt för dig nu att se vad som är \Emph{detaljer} som du inte ska hänga upp dig på och vad som är \Emph{det viktiga} i detta läget. Men det kommer! Ha tålamod! 
\end{itemize}
