...
\end{REPL}
Funktioner som tar en funktion som parameter \Emph{högre ordningens funktion}. 
Funktionerna \code{två} från tidigare och \code{map} ovan är alltså av högre ordningen.
\end{Slide} 
