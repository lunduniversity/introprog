...
\begin{itemize}
\item  Man behöver inte sätta namn på funktioner. De kan i stället skapas med hjälp av \Emph{funktionsliteraler}.\footnote{Även kallade ''lambda-värden'' efter den s.k. lambdakalkylen.}
...
\end{itemize}
\item ...kan man endast göra \Emph{överlagring} men inget annat i Java 7, 
\item medan även \Emph{anonyma funktioner} (''lambda'') går att göra (med vissa begränsningar) i Java 8.
\item En av de saker jag saknar mest i Java: \Alert{lokala funktioner}!
\end{itemize}
