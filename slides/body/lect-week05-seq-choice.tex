...
\begin{itemize}
\item \Emph{Oföränderliga}:  Kan ej ändra elementreferenserna, men effektiva på att skapa kopia som är (delvis) förändrad\\(vanliga i Scala men inte i Java): \Emph{Vector} eller \Emph{List}

\item \Alert{Förändringsbara}: kan ändra elemententreferenserna
  \begin{itemize} 
