...
\begin{Slide}{Terminologi}\SlideFontTiny
...
\code|final class|      & deklarerar en final klass, förhindrar arv\\
\code|super.gurka|      & refererar till supertypens medlem \code|gurka| (jfm \code|this|)\\
\end{tabular}
...
\vspace{-0.0em}\scalainputlisting[numbers=left,numberstyle=,basicstyle=\fontsize{6}{7.5}\ttfamily\selectfont]{../compendium/examples/workspace/w07-inherit/src/vego.scala}
\end{Slide}
