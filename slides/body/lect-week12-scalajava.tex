...
\begin{itemize}\footnotesize
\item Man måste bestämma sig för antalet element vid \code{new}. 
...
\item Namnet \code{ArrayList} är inte helt lyckat, eftersom ordet ''lista'' normalt används för länkade snarare än vektor-liknande strukturer.
\end{itemize}
\end{Slide}
...
\Subsection{Equals}\SlideFontSmall
\begin{Slide}{Fallgrop med samlingar: \\ metoden contains kräver implementation av equals}
...
\begin{Slide}{Fördjupning: scala.collection.JavaConverters}
\end{Slide}

\begin{Slide}{Fördjupning: Gränssnittet List i Java}
\end{Slide}

\begin{Slide}{Fördjupning: Skapa generisk Array}
TypeTag
\end{Slide}
