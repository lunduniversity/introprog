...
\begin{Slide}{Många nyheter i senare Java-versioner}\SlideFontSmall
Java har på senare år utvecklats i rask takt och lånat mycket från t.ex. Scala.

\vspace{0.5em}\begin{tabular}{l l p{0.6\textwidth}}
Version & År & Några viktiga nyheter \\\hline
5--8 & 2004--2014 & generics, lambda, Optional\\ 
9--11  & 2017--2018 & jshell, var type inference, Unicode, parallel GC \\
12--17 & 2019--2021 & switch expressions, multi-line strings, sealed classes, records\\
18--21  & 2022--2023 & pattern matching, virtuella trådar, sequenced collections\\
22--25  & 2024--2025 & simple main methods, unnamed variables (underscore), compact object headers\\
\hline
\end{tabular}

\vspace{3em} 8, 11, 17, 21, 25 är LTS = \emph{Long Term Support}, underhålls extra länge

Läs mer här: \url{https://en.wikipedia.org/wiki/Java_version_history}
\end{Slide}

% \begin{Slide}{''Hello world!'' i Java.}

% \noindent Huvudprogram i Java:
...
% \pause
% \vspace{1em}\noindent Från Java 25 finns förenklade main-metoder:
% \begin{Code}[language=Java]
%  void main() {
%     System.out.println("Hello world!");
% }
...
\begin{Slide}{Några saker som finns i Scala men inte i Java (ännu...)}\SlideFontTiny
\ifkompendium\else
\vspace{-1em}\begin{multicols}{2}
\fi
...
I java finns numera records som liknar case-klasser:

\begin{CodeSmall}[language=Java,basicstyle=\ttfamily\SlideFontSize{5}{6}]
public record Person (String name, int age) {}
\end{CodeSmall}
Konstruktor, getters och equals + hashcode genereras.

\ifkompendium\else\columnbreak\fi

\noindent En oföränderlig klass i \Emph{Java} med \Alert{motsvarande} funktionalitet kräver egen implementation av dessa metoder:
...
\begin{Code}[numberstyle=,language=Java]
/** Tar reda på elementet på plats index */
public E get(int index);

/** Lägger in objektet e sist och returnerar true*/
public boolean add(E e);

/** Lägger in obj på plats index; efterföljande flyttas */
public void add(int index, E e);

/** Tar bort elementet på plats index och returnerar det */
...
\begin{Slide}{\ifswedish Wrapper-klassen {\tt Integer}\else The wrapper class {\tt Integer}\fi}\SlideFontSmall
...
\begin{Slide}{Wrapper-klasser i {\tt java.lang}}\SlideFontSmall
\begin{tabular}{l | l}
