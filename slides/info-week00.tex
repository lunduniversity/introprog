...
\newcommand{\DateOfShow}{2019-08-29}
\newcommand{\KursStartTid}{måndag kl 13:15 i MA:6}
...
\frame{\frametitle{Välkommen till kursupprop på \KursStartTid}
\includegraphics[width=0.8\textwidth]{../img/ehuset}

Besök kurshemsidorna för mer information: \\
\url{http://cs.lth.se/pgk} \\
\url{http://cs.lth.se/dod}
