...
\newcommand{\DateOfShow}{HT2023} %tisdag vecka 0 för D, onsdag för C
...
\begin{Slide}{Bokpaket}
  ...
  \item \Emph{Efterbeställning} är möjlig från idag (nu) via Canvas. De som efterbeställer innan kl 15 idag får paketpriset \BokpaketBilligt kr, sedan kostar enstaka tryck \Alert{\BokpaketDyrt} kr.
  \end{itemize}
\end{Slide}
