...
\begin{itemize}
  \item Priset på själva kodskrivandet sjunker drastiskt och efterfrågan på mjukvara kommer öka enormt
  \item Utmaning: hållbarhet i komplexa snabbväxande kodbaser
  \item Kravhantering, verifiering, design, arkitektur blir huvudfokus 
  \item Erfarna utvecklare är produktiva med djup kodförståelse
  \item Den individuella kodningsförmågan och djup förståelse för systemutveckling är grunden för att bygga erfarenhet som sedan kan användas i agentisk programvaruteknik
\end{itemize}
}
...
\begin{Slide}{Tips för framgång i programmeringsstudier}
  \begin{itemize}
    ...
    \item Hårt arbete
    \item Fokus på självständig förmåga att koda
...
\begin{Slide}{Uthämtning av bokpaket}
  ...
  \item Beställer du före kl 15:15 idag garanteras du paketpris \Emph{\BokpaketBilligt}~kr.
